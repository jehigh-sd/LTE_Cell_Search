-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\zynqRadioHWSWLTEPBCHGeneratorRFSoC2x2\LTE_GENER_ip_src_Discrete_FIR_Filter_HDL_Optimized6.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LTE_GENER_ip_src_Discrete_FIR_Filter_HDL_Optimized6
...
ENTITY LTE_GENER_ip_src_Discrete_FIR_Filter_HDL_Optimized6 IS
...
END LTE_GENER_ip_src_Discrete_FIR_Filter_HDL_Optimized6;


ARCHITECTURE rtl OF LTE_GENER_ip_src_Discrete_FIR_Filter_HDL_Optimized6 IS

  -- Component Declarations
  COMPONENT LTE_GENER_ip_src_Filter_block5
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn_re                       :   IN    std_logic_vector(15 DOWNTO 0);  -- int16
  ...
  FOR ALL : LTE_GENER_ip_src_Filter_block5
    USE ENTITY work.LTE_GENER_ip_src_Filter_block5(rtl);
...
BEGIN
  u_FilterBank : LTE_GENER_ip_src_Filter_block5
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,

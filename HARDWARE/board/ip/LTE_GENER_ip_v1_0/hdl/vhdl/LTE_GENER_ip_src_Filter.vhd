-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\zynqRadioHWSWLTEPBCHGeneratorRFSoC2x2\LTE_GENER_ip_src_Filter.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LTE_GENER_ip_src_Filter
...
-- FIR Filter HDL Optimized/Filte
-- Hierarchy Level: 5
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY LTE_GENER_ip_src_Filter IS
...
END LTE_GENER_ip_src_Filter;


ARCHITECTURE rtl OF LTE_GENER_ip_src_Filter IS

  -- Component Declarations
  COMPONENT LTE_GENER_ip_src_FilterCoef
    PORT( CoefOut_0                       :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
          CoefOut_1                       :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
          CoefOut_2                       :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
          CoefOut_3                       :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
          CoefOut_4                       :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
          CoefOut_5                       :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
          CoefOut_6                       :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
          CoefOut_7                       :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
          CoefOut_8                       :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
          CoefOut_9                       :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
          CoefOut_10                      :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
          CoefOut_11                      :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
          CoefOut_12                      :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
          CoefOut_13                      :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
          CoefOut_14                      :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
          CoefOut_15                      :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
          CoefOut_16                      :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
          CoefOut_17                      :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
          CoefOut_18                      :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
          CoefOut_19                      :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
          CoefOut_20                      :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
          CoefOut_21                      :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
          CoefOut_22                      :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
          CoefOut_23                      :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
          CoefOut_24                      :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
          CoefOut_25                      :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
          CoefOut_26                      :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
          CoefOut_27                      :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
          CoefOut_28                      :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
          CoefOut_29                      :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
          CoefOut_30                      :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En14
          CoefOut_31                      :   OUT   std_logic_vector(15 DOWNTO 0)  -- sfix16_En14
          );
  END COMPONENT;

  COMPONENT LTE_GENER_ip_src_subFilter
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : LTE_GENER_ip_src_FilterCoef
    USE ENTITY work.LTE_GENER_ip_src_FilterCoef(rtl);

  FOR ALL : LTE_GENER_ip_src_subFilter
    USE ENTITY work.LTE_GENER_ip_src_subFilter(rtl);
...
BEGIN
  u_CoefTable_1 : LTE_GENER_ip_src_FilterCoef
    PORT MAP( CoefOut_0 => CoefOut_0,  -- sfix16_En14
              ...
              CoefOut_16 => CoefOut_16,  -- sfix16_En14
              CoefOut_17 => CoefOut_17,  -- sfix16_En14
              CoefOut_18 => CoefOut_18,  -- sfix16_En14
              CoefOut_19 => CoefOut_19,  -- sfix16_En14
              CoefOut_20 => CoefOut_20,  -- sfix16_En14
              CoefOut_21 => CoefOut_21,  -- sfix16_En14
              CoefOut_22 => CoefOut_22,  -- sfix16_En14
              CoefOut_23 => CoefOut_23,  -- sfix16_En14
              CoefOut_24 => CoefOut_24,  -- sfix16_En14
              CoefOut_25 => CoefOut_25,  -- sfix16_En14
              CoefOut_26 => CoefOut_26,  -- sfix16_En14
              CoefOut_27 => CoefOut_27,  -- sfix16_En14
              CoefOut_28 => CoefOut_28,  -- sfix16_En14
              CoefOut_29 => CoefOut_29,  -- sfix16_En14
              CoefOut_30 => CoefOut_30,  -- sfix16_En14
              CoefOut_31 => CoefOut_31  -- sfix16_En14
              );

  u_subFilter_1_re : LTE_GENER_ip_src_subFilter
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              ...
              coefIn_16 => CoefOut_16,  -- sfix16_En14
              coefIn_17 => CoefOut_17,  -- sfix16_En14
              coefIn_18 => CoefOut_18,  -- sfix16_En14
              coefIn_19 => CoefOut_19,  -- sfix16_En14
              coefIn_20 => CoefOut_20,  -- sfix16_En14
              coefIn_21 => CoefOut_21,  -- sfix16_En14
              coefIn_22 => CoefOut_22,  -- sfix16_En14
              coefIn_23 => CoefOut_23,  -- sfix16_En14
              coefIn_24 => CoefOut_24,  -- sfix16_En14
              coefIn_25 => CoefOut_25,  -- sfix16_En14
              coefIn_26 => CoefOut_26,  -- sfix16_En14
              coefIn_27 => CoefOut_27,  -- sfix16_En14
              coefIn_28 => CoefOut_28,  -- sfix16_En14
              coefIn_29 => CoefOut_29,  -- sfix16_En14
              coefIn_30 => CoefOut_30,  -- sfix16_En14
              coefIn_31 => CoefOut_31,  -- sfix16_En14
  ...
  u_subFilter_1_im : LTE_GENER_ip_src_subFilter
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,

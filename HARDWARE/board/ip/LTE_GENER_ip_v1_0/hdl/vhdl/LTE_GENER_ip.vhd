-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\zynqRadioHWSWLTEPBCHGeneratorRFSoC2x2\LTE_GENER_ip.vhd
...
ENTITY LTE_GENER_ip IS
  PORT( IPCORE_CLK                        :   IN    std_logic;  -- ufix1
        ...
        AXI4_Stream_I_Master_TDATA        :   OUT   std_logic_vector(127 DOWNTO 0);  -- ufix128
...
ARCHITECTURE rtl OF LTE_GENER_ip IS

  -- Component Declarations
  COMPONENT LTE_GENER_ip_reset_sync
  ...
  COMPONENT LTE_GENER_ip_axi_lite
  ...
  COMPONENT LTE_GENER_ip_axi4_stream_q_master
    PORT( clk                             :   IN    std_logic;  -- ufix1
  ...
  COMPONENT LTE_GENER_ip_axi4_stream_i_master
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_I_Master_TREADY     :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : LTE_GENER_ip_reset_sync
    USE ENTITY work.LTE_GENER_ip_reset_sync(rtl);

  FOR ALL : LTE_GENER_ip_axi_lite
    USE ENTITY work.LTE_GENER_ip_axi_lite(rtl);

  FOR ALL : LTE_GENER_ip_axi4_stream_q_master
    USE ENTITY work.LTE_GENER_ip_axi4_stream_q_master(rtl);

  FOR ALL : LTE_GENER_ip_dut
    USE ENTITY work.LTE_GENER_ip_dut(rtl);

  FOR ALL : LTE_GENER_ip_axi4_stream_i_master
    USE ENTITY work.LTE_GENER_ip_axi4_stream_i_master(rtl);
  ...
  SIGNAL write_testSelect_In              : std_logic_vector(31 DOWNTO 0);  -- ufix32
  ...
  SIGNAL AXI4_Stream_I_Master_TDATA_tmp   : std_logic_vector(127 DOWNTO 0);  -- ufix128

BEGIN
  u_LTE_GENER_ip_reset_sync_inst : LTE_GENER_ip_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset_x
              );

  u_LTE_GENER_ip_axi_lite_inst : LTE_GENER_ip_axi_lite
    PORT MAP( reset_x => reset_x,
              ...
              write_testSelect_In => write_testSelect_In,  -- sfix32
              reset_internal => reset_internal  -- ufix1
              );

  u_LTE_GENER_ip_axi4_stream_q_master_inst : LTE_GENER_ip_axi4_stream_q_master
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_x => reset_x,
              enb => const_1_1,
              AXI4_Stream_Q_Master_TREADY => AXI4_Stream_Q_Master_TREADY,  -- ufix1
              user_data => txDataOutQ_sig,  -- ufix128
              user_valid => txValidOutQ_sig,  -- ufix1
              write_packet_size_axi4_stream_q_master => write_packet_size_axi4_stream_q_master,  -- ufix32
              AXI4_Stream_Q_Master_TDATA => AXI4_Stream_Q_Master_TDATA_tmp,  -- ufix128
  ...
  u_LTE_GENER_ip_dut_inst : LTE_GENER_ip_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_x => reset_x,
              dut_enable => write_axi_enable,  -- ufix1
              txready_I => top_user_ready_1,  -- ufix1
              txready_Q => top_user_ready,  -- ufix1
              testSelect_In => write_testSelect_In,  -- sfix32
  ...
  u_LTE_GENER_ip_axi4_stream_i_master_inst : LTE_GENER_ip_axi4_stream_i_master
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_x => reset_x,
              enb => const_1_1,
              AXI4_Stream_I_Master_TREADY => AXI4_Stream_I_Master_TREADY,  -- ufix1
              user_data => txDataOutI_sig,  -- ufix128
              user_valid => txValidOutI_sig,  -- ufix1
              write_packet_size_axi4_stream_i_master => write_packet_size_axi4_stream_i_master,  -- ufix32
              AXI4_Stream_I_Master_TDATA => AXI4_Stream_I_Master_TDATA_tmp,  -- ufix128
  ...
  ip_timestamp <= unsigned'(X"83712A60");

-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\zynqRadioHWSWLTEPBCHGeneratorRFSoC2x2\LTE_GENER_ip_src_FilterCoef_block4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LTE_GENER_ip_src_FilterCoef_block4
...
-- FIR Filter HDL Optimized5/Filter/FilterCoe
-- Hierarchy Level: 6
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY LTE_GENER_ip_src_FilterCoef_block4 IS
...
END LTE_GENER_ip_src_FilterCoef_block4;


ARCHITECTURE rtl OF LTE_GENER_ip_src_FilterCoef_block4 IS
...
BEGIN
  ...
  -- CoefReg_31
  CoefData_30 <= to_signed(16#000A#, 16);

  CoefOut_30 <= std_logic_vector(CoefData_30);

  -- CoefReg_32
  CoefData_31 <= to_signed(-16#0003#, 16);

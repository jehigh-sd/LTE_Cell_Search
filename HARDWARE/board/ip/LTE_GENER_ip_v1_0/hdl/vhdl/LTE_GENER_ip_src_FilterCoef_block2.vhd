-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\zynqRadioHWSWLTEPBCHGeneratorRFSoC2x2\LTE_GENER_ip_src_FilterCoef_block2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LTE_GENER_ip_src_FilterCoef_block2
...
-- FIR Filter HDL Optimized3/Filter/FilterCoe
-- Hierarchy Level: 6
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY LTE_GENER_ip_src_FilterCoef_block2 IS
...
END LTE_GENER_ip_src_FilterCoef_block2;


ARCHITECTURE rtl OF LTE_GENER_ip_src_FilterCoef_block2 IS
...
BEGIN
  ...
  -- CoefReg_2
  CoefData_1 <= to_signed(16#000A#, 16);
  ...
  -- CoefReg_30
  CoefData_29 <= to_signed(-16#001D#, 16);

  CoefOut_29 <= std_logic_vector(CoefData_29);

  -- CoefReg_31
  CoefData_30 <= to_signed(16#000D#, 16);

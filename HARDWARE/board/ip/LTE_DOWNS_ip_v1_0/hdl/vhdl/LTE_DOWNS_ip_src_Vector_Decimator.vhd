-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\zynqRadioHWSWLTEDecimatorRFSoC2x2\LTE_DOWNS_ip_src_Vector_Decimator.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LTE_DOWNS_ip_src_Vector_Decimator
-- Source Path: zynqRadioHWSWLTEDecimatorRFSoC2x2/LTE_DOWNSAMPLE_HDL/DOWNSAMPLE/Vector Decimator
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY LTE_DOWNS_ip_src_Vector_Decimator IS
...
END LTE_DOWNS_ip_src_Vector_Decimator;


ARCHITECTURE rtl OF LTE_DOWNS_ip_src_Vector_Decimator IS

  -- Component Declarations
  COMPONENT LTE_DOWNS_ip_src_ADC_To_Vector_Q
  ...
  COMPONENT LTE_DOWNS_ip_src_ADC_To_Vector_I
    PORT( packed_in                       :   IN    std_logic_vector(127 DOWNTO 0);  -- ufix128
          Out1_0                          :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En15
          Out1_1                          :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En15
          Out1_2                          :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En15
  ...
  COMPONENT LTE_DOWNS_ip_src_Decimation
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : LTE_DOWNS_ip_src_ADC_To_Vector_Q
    USE ENTITY work.LTE_DOWNS_ip_src_ADC_To_Vector_Q(rtl);

  FOR ALL : LTE_DOWNS_ip_src_ADC_To_Vector_I
    USE ENTITY work.LTE_DOWNS_ip_src_ADC_To_Vector_I(rtl);

  FOR ALL : LTE_DOWNS_ip_src_Decimation
    USE ENTITY work.LTE_DOWNS_ip_src_Decimation(rtl);
  ...
  SIGNAL Decimation_out2                  : std_logic;
...
BEGIN
  u_ADC_To_Vector_Q : LTE_DOWNS_ip_src_ADC_To_Vector_Q
  ...
  u_ADC_To_Vector_I : LTE_DOWNS_ip_src_ADC_To_Vector_I
  ...
  u_Decimation : LTE_DOWNS_ip_src_Decimation
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,

-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\zynqRadioHWSWLTEDecimatorRFSoC2x2\LTE_DOWNS_ip_axi4_stream_i_master.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LTE_DOWNS_ip_axi4_stream_i_master
-- Source Path: LTE_DOWNS_ip/LTE_DOWNS_ip_axi4_stream_i_master
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY LTE_DOWNS_ip_axi4_stream_i_master IS
...
END LTE_DOWNS_ip_axi4_stream_i_master;


ARCHITECTURE rtl OF LTE_DOWNS_ip_axi4_stream_i_master IS

  -- Component Declarations
  COMPONENT LTE_DOWNS_ip_fifo_data_OUT
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT LTE_DOWNS_ip_fifo_TLAST_OUT
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : LTE_DOWNS_ip_fifo_data_OUT
    USE ENTITY work.LTE_DOWNS_ip_fifo_data_OUT(rtl);

  FOR ALL : LTE_DOWNS_ip_fifo_TLAST_OUT
    USE ENTITY work.LTE_DOWNS_ip_fifo_TLAST_OUT(rtl);
  ...
  SIGNAL write_packet_size_axi4_stream_i_master_unsigned : unsigned(31 DOWNTO 0);  -- ufix32
...
BEGIN
  u_LTE_DOWNS_ip_fifo_data_OUT_inst : LTE_DOWNS_ip_fifo_data_OUT
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              ...
              Out_rsvd => AXI4_Stream_I_Master_TDATA_tmp,  -- ufix16
              Empty => fifo_empty_data,  -- ufix1
              AFull => fifo_afull_data  -- ufix1
              );

  u_LTE_DOWNS_ip_fifo_TLAST_OUT_inst : LTE_DOWNS_ip_fifo_TLAST_OUT
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              In_rsvd => auto_tlast,  -- ufix1
              Push => out_fifo_push_master,  -- ufix1
              Pop => AXI4_Stream_I_Master_TREADY,  -- ufix1
              Out_rsvd => AXI4_Stream_I_Master_TLAST  -- ufix1
              );
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        multirate_int_delay_port_tready_reg(0) <= AXI4_Stream_I_Master_TREADY;
  ...
  AXI4_Stream_I_Master_TVALID <=  NOT fifo_empty_data;

  write_packet_size_axi4_stream_i_master_unsigned <= unsigned(write_packet_size_axi4_stream_i_master);

  const_1 <= to_unsigned(1, 32);

  tlast_size_value <= write_packet_size_axi4_stream_i_master_unsigned - const_1;

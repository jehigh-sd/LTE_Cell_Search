-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\zynqRadioHWSWLTEDecimatorRFSoC2x2\LTE_DOWNS_ip_src_FilterBank.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LTE_DOWNS_ip_src_FilterBank
...
ENTITY LTE_DOWNS_ip_src_FilterBank IS
...
END LTE_DOWNS_ip_src_FilterBank;


ARCHITECTURE rtl OF LTE_DOWNS_ip_src_FilterBank IS

  -- Component Declarations
  COMPONENT LTE_DOWNS_ip_src_FilterCoef
  ...
  COMPONENT LTE_DOWNS_ip_src_subFilter
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT LTE_DOWNS_ip_src_FilterCoef_block
    PORT( CoefOut_0                       :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En16
          CoefOut_1                       :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En16
          CoefOut_2                       :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En16
          CoefOut_3                       :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En16
  ...
  COMPONENT LTE_DOWNS_ip_src_subFilter_block
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT LTE_DOWNS_ip_src_FilterCoef_block1
    PORT( CoefOut_0                       :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En16
          CoefOut_1                       :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En16
          CoefOut_2                       :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En16
          CoefOut_3                       :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En16
  ...
  COMPONENT LTE_DOWNS_ip_src_subFilter_block1
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT LTE_DOWNS_ip_src_FilterCoef_block2
    PORT( CoefOut_0                       :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En16
          CoefOut_1                       :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En16
          CoefOut_2                       :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En16
          CoefOut_3                       :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En16
  ...
  COMPONENT LTE_DOWNS_ip_src_subFilter_block2
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT LTE_DOWNS_ip_src_FilterCoef_block3
    PORT( CoefOut_0                       :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En16
          CoefOut_1                       :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En16
          CoefOut_2                       :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En16
          CoefOut_3                       :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En16
  ...
  COMPONENT LTE_DOWNS_ip_src_subFilter_block3
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT LTE_DOWNS_ip_src_FilterCoef_block4
    PORT( CoefOut_0                       :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En16
          CoefOut_1                       :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En16
          CoefOut_2                       :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En16
          CoefOut_3                       :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En16
  ...
  COMPONENT LTE_DOWNS_ip_src_subFilter_block4
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT LTE_DOWNS_ip_src_FilterCoef_block5
    PORT( CoefOut_0                       :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En16
          CoefOut_1                       :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En16
          CoefOut_2                       :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En16
          CoefOut_3                       :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En16
  ...
  COMPONENT LTE_DOWNS_ip_src_subFilter_block5
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT LTE_DOWNS_ip_src_FilterCoef_block6
    PORT( CoefOut_0                       :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En16
          CoefOut_1                       :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En16
          CoefOut_2                       :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En16
          CoefOut_3                       :   OUT   std_logic_vector(15 DOWNTO 0);  -- sfix16_En16
  ...
  COMPONENT LTE_DOWNS_ip_src_subFilter_block6
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : LTE_DOWNS_ip_src_FilterCoef
    USE ENTITY work.LTE_DOWNS_ip_src_FilterCoef(rtl);

  FOR ALL : LTE_DOWNS_ip_src_subFilter
    USE ENTITY work.LTE_DOWNS_ip_src_subFilter(rtl);

  FOR ALL : LTE_DOWNS_ip_src_FilterCoef_block
    USE ENTITY work.LTE_DOWNS_ip_src_FilterCoef_block(rtl);

  FOR ALL : LTE_DOWNS_ip_src_subFilter_block
    USE ENTITY work.LTE_DOWNS_ip_src_subFilter_block(rtl);

  FOR ALL : LTE_DOWNS_ip_src_FilterCoef_block1
    USE ENTITY work.LTE_DOWNS_ip_src_FilterCoef_block1(rtl);

  FOR ALL : LTE_DOWNS_ip_src_subFilter_block1
    USE ENTITY work.LTE_DOWNS_ip_src_subFilter_block1(rtl);

  FOR ALL : LTE_DOWNS_ip_src_FilterCoef_block2
    USE ENTITY work.LTE_DOWNS_ip_src_FilterCoef_block2(rtl);

  FOR ALL : LTE_DOWNS_ip_src_subFilter_block2
    USE ENTITY work.LTE_DOWNS_ip_src_subFilter_block2(rtl);

  FOR ALL : LTE_DOWNS_ip_src_FilterCoef_block3
    USE ENTITY work.LTE_DOWNS_ip_src_FilterCoef_block3(rtl);

  FOR ALL : LTE_DOWNS_ip_src_subFilter_block3
    USE ENTITY work.LTE_DOWNS_ip_src_subFilter_block3(rtl);

  FOR ALL : LTE_DOWNS_ip_src_FilterCoef_block4
    USE ENTITY work.LTE_DOWNS_ip_src_FilterCoef_block4(rtl);

  FOR ALL : LTE_DOWNS_ip_src_subFilter_block4
    USE ENTITY work.LTE_DOWNS_ip_src_subFilter_block4(rtl);

  FOR ALL : LTE_DOWNS_ip_src_FilterCoef_block5
    USE ENTITY work.LTE_DOWNS_ip_src_FilterCoef_block5(rtl);

  FOR ALL : LTE_DOWNS_ip_src_subFilter_block5
    USE ENTITY work.LTE_DOWNS_ip_src_subFilter_block5(rtl);

  FOR ALL : LTE_DOWNS_ip_src_FilterCoef_block6
    USE ENTITY work.LTE_DOWNS_ip_src_FilterCoef_block6(rtl);

  FOR ALL : LTE_DOWNS_ip_src_subFilter_block6
    USE ENTITY work.LTE_DOWNS_ip_src_subFilter_block6(rtl);
...
BEGIN
  u_CoefTable_1 : LTE_DOWNS_ip_src_FilterCoef
  ...
  u_subFilter_1_re : LTE_DOWNS_ip_src_subFilter
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_CoefTable_2 : LTE_DOWNS_ip_src_FilterCoef_block
  ...
  u_subFilter_2_re : LTE_DOWNS_ip_src_subFilter_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_CoefTable_3 : LTE_DOWNS_ip_src_FilterCoef_block1
  ...
  u_subFilter_3_re : LTE_DOWNS_ip_src_subFilter_block1
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_CoefTable_4 : LTE_DOWNS_ip_src_FilterCoef_block2
  ...
  u_subFilter_4_re : LTE_DOWNS_ip_src_subFilter_block2
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_CoefTable_5 : LTE_DOWNS_ip_src_FilterCoef_block3
  ...
  u_subFilter_5_re : LTE_DOWNS_ip_src_subFilter_block3
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_CoefTable_6 : LTE_DOWNS_ip_src_FilterCoef_block4
  ...
  u_subFilter_6_re : LTE_DOWNS_ip_src_subFilter_block4
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_CoefTable_7 : LTE_DOWNS_ip_src_FilterCoef_block5
  ...
  u_subFilter_7_re : LTE_DOWNS_ip_src_subFilter_block5
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_CoefTable_8 : LTE_DOWNS_ip_src_FilterCoef_block6
  ...
  u_subFilter_8_re : LTE_DOWNS_ip_src_subFilter_block6
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_subFilter_1_im : LTE_DOWNS_ip_src_subFilter
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_subFilter_2_im : LTE_DOWNS_ip_src_subFilter_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_subFilter_3_im : LTE_DOWNS_ip_src_subFilter_block1
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_subFilter_4_im : LTE_DOWNS_ip_src_subFilter_block2
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_subFilter_5_im : LTE_DOWNS_ip_src_subFilter_block3
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_subFilter_6_im : LTE_DOWNS_ip_src_subFilter_block4
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_subFilter_7_im : LTE_DOWNS_ip_src_subFilter_block5
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_subFilter_8_im : LTE_DOWNS_ip_src_subFilter_block6
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,

-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\zynqRadioHWSWLTEDecimatorRFSoC2x2\LTE_DOWNS_ip_src_subFilter_block5.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LTE_DOWNS_ip_src_subFilter_block5
...
ENTITY LTE_DOWNS_ip_src_subFilter_block5 IS
...
END LTE_DOWNS_ip_src_subFilter_block5;


ARCHITECTURE rtl OF LTE_DOWNS_ip_src_subFilter_block5 IS

  -- Component Declarations
  COMPONENT LTE_DOWNS_ip_src_FilterTapSystolicWvldin_block5
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
          dinReg2_6_re                    :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En15
          coefIn_0                        :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En16
  ...
  FOR ALL : LTE_DOWNS_ip_src_FilterTapSystolicWvldin_block5
    USE ENTITY work.LTE_DOWNS_ip_src_FilterTapSystolicWvldin_block5(rtl);
...
BEGIN
  u_FilterTap_1 : LTE_DOWNS_ip_src_FilterTapSystolicWvldin_block5
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_2 : LTE_DOWNS_ip_src_FilterTapSystolicWvldin_block5
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_3 : LTE_DOWNS_ip_src_FilterTapSystolicWvldin_block5
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_4 : LTE_DOWNS_ip_src_FilterTapSystolicWvldin_block5
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_5 : LTE_DOWNS_ip_src_FilterTapSystolicWvldin_block5
    PORT MAP( clk => clk,
              enb => enb,

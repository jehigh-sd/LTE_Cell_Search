-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\zynqRadioHWSWLTEDecimatorRFSoC2x2\LTE_DOWNS_ip_src_ADC_To_Vector_Q.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LTE_DOWNS_ip_src_ADC_To_Vector_Q
-- Source Path: zynqRadioHWSWLTEDecimatorRFSoC2x2/LTE_DOWNSAMPLE_HDL/DOWNSAMPLE/Vector Decimator/ADC To Vector Q
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY LTE_DOWNS_ip_src_ADC_To_Vector_Q IS
...
END LTE_DOWNS_ip_src_ADC_To_Vector_Q;


ARCHITECTURE rtl OF LTE_DOWNS_ip_src_ADC_To_Vector_Q IS

  -- Component Declarations
  COMPONENT LTE_DOWNS_ip_src_Unpack_into_vector_v2_block
    PORT( packed_in                       :   IN    std_logic_vector(127 DOWNTO 0);  -- ufix128
  ...
  FOR ALL : LTE_DOWNS_ip_src_Unpack_into_vector_v2_block
    USE ENTITY work.LTE_DOWNS_ip_src_Unpack_into_vector_v2_block(rtl);
...
BEGIN
  u_Unpack_into_vector_v2 : LTE_DOWNS_ip_src_Unpack_into_vector_v2_block

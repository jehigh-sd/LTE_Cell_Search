-- ------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\zynqRadioHWSWLTEDecimatorRFSoC2x2\LTE_DOWNS_ip_src_CIC_Interpolation1
-- Created: 2022-05-25 15:55:21
...
-- ------------------------------------------------------------
-- 
-- Module: LTE_DOWNS_ip_src_CIC_Interpolation1
-- Source Path: /LTE_DOWNS_ip_src_CIC_Interpolation1
-- 
-- ------------------------------------------------------------
-- 
...
ENTITY LTE_DOWNS_ip_src_CIC_Interpolation1 IS
   PORT( clk                             :   IN    std_logic; 
         enb_1_1_1                       :   IN    std_logic; 
         reset_x                         :   IN    std_logic; 
         LTE_DOWNS_ip_src_CIC_Interpolation1_in_re:   IN    std_logic_vector(15 DOWNTO 0); -- sfix16_En15
         LTE_DOWNS_ip_src_CIC_Interpolation1_in_im:   IN    std_logic_vector(15 DOWNTO 0); -- sfix16_En15
         LTE_DOWNS_ip_src_CIC_Interpolation1_out_re:   OUT   std_logic_vector(25 DOWNTO 0); -- sfix26_En15
         LTE_DOWNS_ip_src_CIC_Interpolation1_out_im:   OUT   std_logic_vector(25 DOWNTO 0)  -- sfix26_En15
         );

END LTE_DOWNS_ip_src_CIC_Interpolation1;


----------------------------------------------------------------
--Module Architecture: LTE_DOWNS_ip_src_CIC_Interpolation1
----------------------------------------------------------------
ARCHITECTURE rtl OF LTE_DOWNS_ip_src_CIC_Interpolation1 IS
  -- Local Functions
  -- Type Definitions
  -- Constants
...
BEGIN
  ...
  input_typeconvert_re <= signed(LTE_DOWNS_ip_src_CIC_Interpolation1_in_re);
  input_typeconvert_im <= signed(LTE_DOWNS_ip_src_CIC_Interpolation1_in_im);
  ...
  LTE_DOWNS_ip_src_CIC_Interpolation1_out_re <= std_logic_vector(muxout_re);
  LTE_DOWNS_ip_src_CIC_Interpolation1_out_im <= std_logic_vector(muxout_im);
END rtl;

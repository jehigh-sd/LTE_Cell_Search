-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\zynqRadioHWSWLTEMIBDetectorRFSoC2x2\LTE_MIB_H_ip_src_FIR_Decimation_HDL_Optimized1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LTE_MIB_H_ip_src_FIR_Decimation_HDL_Optimized1
...
ENTITY LTE_MIB_H_ip_src_FIR_Decimation_HDL_Optimized1 IS
...
END LTE_MIB_H_ip_src_FIR_Decimation_HDL_Optimized1;


ARCHITECTURE rtl OF LTE_MIB_H_ip_src_FIR_Decimation_HDL_Optimized1 IS

  -- Component Declarations
  COMPONENT LTE_MIB_H_ip_src_FilterBank
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT LTE_MIB_H_ip_src_sumTree
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : LTE_MIB_H_ip_src_FilterBank
    USE ENTITY work.LTE_MIB_H_ip_src_FilterBank(rtl);

  FOR ALL : LTE_MIB_H_ip_src_sumTree
    USE ENTITY work.LTE_MIB_H_ip_src_sumTree(rtl);
...
BEGIN
  u_FilterBank : LTE_MIB_H_ip_src_FilterBank
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_FirDecimAcc : LTE_MIB_H_ip_src_sumTree
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              filterOut_re_0 => filterOut_re_0,  -- sfix33_En31

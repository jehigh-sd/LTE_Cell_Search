-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\zynqRadioHWSWLTEMIBDetectorRFSoC2x2\ltehdlDownlinkSyncDemod\LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_C_D_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_C_D_block
...
ENTITY LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_C_D_block IS
...
END LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_C_D_block;


ARCHITECTURE rtl OF LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_C_D_block IS

  -- Component Declarations
  COMPONENT LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FirRdyLogic_block2
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  COMPONENT LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_Addressable_Delay_Line_block5
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  COMPONENT LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FilterTapSystolic_block1
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FirRdyLogic_block2
    USE ENTITY work_ltehdlDownlinkSyncDemod.LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FirRdyLogic_block2(rtl);

  FOR ALL : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_Addressable_Delay_Line_block5
    USE ENTITY work_ltehdlDownlinkSyncDemod.LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_Addressable_Delay_Line_block5(rtl);

  FOR ALL : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FilterTapSystolic_block1
    USE ENTITY work_ltehdlDownlinkSyncDemod.LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FilterTapSystolic_block1(rtl);
...
BEGIN
  u_firRdyLogic : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FirRdyLogic_block2
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine0 : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_Addressable_Delay_Line_block5
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              dataIn => dinSM,  -- ufix16
  ...
  u_delayLine1 : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_Addressable_Delay_Line_block5
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine2 : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_Addressable_Delay_Line_block5
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine3 : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_Addressable_Delay_Line_block5
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_filterTap0 : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FilterTapSystolic_block1
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_filterTap1 : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FilterTapSystolic_block1
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_filterTap2 : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FilterTapSystolic_block1
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_filterTap3 : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FilterTapSystolic_block1
    PORT MAP( clk => clk,
              enb => enb,
  ...
  BEGIN
    CASE rdAddr3 IS
      ...
      WHEN "00001" =>
        coeffTableOut3 <= to_signed(-16#009#, 9);
      WHEN "00010" =>
        coeffTableOut3 <= to_signed(16#03C#, 9);
      WHEN "00011" =>
        coeffTableOut3 <= to_signed(16#01E#, 9);
      WHEN "00100" =>
        coeffTableOut3 <= to_signed(-16#02E#, 9);
      WHEN "00101" =>
      ...
      WHEN "01001" =>
        coeffTableOut3 <= to_signed(-16#053#, 9);
      WHEN "01010" =>
        coeffTableOut3 <= to_signed(-16#028#, 9);
      WHEN "01011" =>
        coeffTableOut3 <= to_signed(16#031#, 9);
      WHEN "01100" =>
        coeffTableOut3 <= to_signed(16#04C#, 9);
      WHEN "01101" =>
      ...
      WHEN "10100" =>
        coeffTableOut3 <= to_signed(-16#01F#, 9);
      WHEN "10101" =>
        coeffTableOut3 <= to_signed(-16#01E#, 9);
      WHEN "10110" =>
  ...
  BEGIN
    CASE rdAddr2 IS
      ...
      WHEN "00001" =>
        coeffTableOut2 <= to_signed(16#03A#, 9);
      WHEN "00010" =>
        coeffTableOut2 <= to_signed(16#031#, 9);
      WHEN "00011" =>
      ...
      WHEN "00111" =>
        coeffTableOut2 <= to_signed(-16#05F#, 9);
      WHEN "01000" =>
        coeffTableOut2 <= to_signed(-16#041#, 9);
      WHEN "01001" =>
        coeffTableOut2 <= to_signed(16#021#, 9);
      WHEN "01010" =>
      ...
      WHEN "10001" =>
        coeffTableOut2 <= to_signed(-16#042#, 9);
      WHEN "10010" =>
        coeffTableOut2 <= to_signed(-16#044#, 9);
      WHEN "10011" =>
        coeffTableOut2 <= to_signed(-16#027#, 9);
      WHEN "10100" =>
        coeffTableOut2 <= to_signed(-16#001#, 9);
      WHEN "10101" =>
      ...
      WHEN "11001" =>
        coeffTableOut2 <= to_signed(16#03F#, 9);
      WHEN "11010" =>
        coeffTableOut2 <= to_signed(16#03C#, 9);
      WHEN "11011" =>
        coeffTableOut2 <= to_signed(16#027#, 9);
      WHEN "11100" =>
        coeffTableOut2 <= to_signed(16#01A#, 9);
      WHEN "11101" =>
        coeffTableOut2 <= to_signed(16#013#, 9);
      WHEN "11110" =>
        coeffTableOut2 <= to_signed(-16#012#, 9);
      WHEN "11111" =>
        coeffTableOut2 <= to_signed(-16#04E#, 9);
      WHEN OTHERS => 
  ...
  BEGIN
    CASE rdAddr1 IS
      WHEN "00000" =>
        coeffTableOut1 <= to_signed(-16#012#, 9);
      WHEN "00001" =>
        coeffTableOut1 <= to_signed(16#013#, 9);
      WHEN "00010" =>
        coeffTableOut1 <= to_signed(16#01A#, 9);
      WHEN "00011" =>
        coeffTableOut1 <= to_signed(16#027#, 9);
      WHEN "00100" =>
        coeffTableOut1 <= to_signed(16#03C#, 9);
      WHEN "00101" =>
        coeffTableOut1 <= to_signed(16#03F#, 9);
      WHEN "00110" =>
        coeffTableOut1 <= to_signed(16#033#, 9);
      WHEN "00111" =>
        coeffTableOut1 <= to_signed(16#030#, 9);
      WHEN "01000" =>
        coeffTableOut1 <= to_signed(16#031#, 9);
      WHEN "01001" =>
        coeffTableOut1 <= to_signed(16#022#, 9);
      WHEN "01010" =>
        coeffTableOut1 <= to_signed(-16#001#, 9);
      WHEN "01011" =>
        coeffTableOut1 <= to_signed(-16#027#, 9);
      WHEN "01100" =>
        coeffTableOut1 <= to_signed(-16#044#, 9);
      WHEN "01101" =>
        coeffTableOut1 <= to_signed(-16#042#, 9);
      WHEN "01110" =>
      ...
      WHEN "10001" =>
        coeffTableOut1 <= to_signed(-16#021#, 9);
      WHEN "10010" =>
      ...
      WHEN "10111" =>
        coeffTableOut1 <= to_signed(-16#05F#, 9);
      WHEN "11000" =>
  ...
  BEGIN
    CASE rdAddr0_1 IS
      ...
      WHEN "01010" =>
        coeffTableOut0 <= to_signed(-16#01F#, 9);
      WHEN "01011" =>
        coeffTableOut0 <= to_signed(-16#030#, 9);
      WHEN "01100" =>
      ...
      WHEN "10010" =>
        coeffTableOut0 <= to_signed(16#04C#, 9);
      WHEN "10011" =>
        coeffTableOut0 <= to_signed(16#031#, 9);
      WHEN "10100" =>
        coeffTableOut0 <= to_signed(-16#028#, 9);
      WHEN "10101" =>
        coeffTableOut0 <= to_signed(-16#053#, 9);
      WHEN "10110" =>
        coeffTableOut0 <= to_signed(-16#018#, 9);
      WHEN "10111" =>
      ...
      WHEN "11010" =>
        coeffTableOut0 <= to_signed(-16#02E#, 9);
      WHEN "11011" =>
        coeffTableOut0 <= to_signed(16#01E#, 9);
      WHEN "11100" =>
        coeffTableOut0 <= to_signed(16#03C#, 9);
      WHEN "11101" =>
        coeffTableOut0 <= to_signed(-16#009#, 9);
      WHEN "11110" =>
        coeffTableOut0 <= to_signed(-16#055#, 9);
      WHEN "11111" =>
        coeffTableOut0 <= to_signed(-16#04E#, 9);
      WHEN OTHERS => 

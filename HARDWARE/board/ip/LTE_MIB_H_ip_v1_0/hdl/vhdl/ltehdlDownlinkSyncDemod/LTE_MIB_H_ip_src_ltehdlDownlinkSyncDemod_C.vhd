-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\zynqRadioHWSWLTEMIBDetectorRFSoC2x2\ltehdlDownlinkSyncDemod\LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_C.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_C
-- Source Path: ltehdlDownlinkSyncDemod/Sync Signal Search/PSS Searcher/Correlators/PSSXCorr0/C
-- Hierarchy Level: 7
-- 
-- Discrete FIR Filter
-- 
...
ENTITY LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_C IS
...
END LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_C;


ARCHITECTURE rtl OF LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_C IS

  -- Component Declarations
  COMPONENT LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FirRdyLogic_block
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(16 DOWNTO 0);  -- ufix17
  ...
  COMPONENT LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_Addressable_Delay_Line_block3
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(16 DOWNTO 0);  -- ufix17
  ...
  COMPONENT LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FilterTapSystolic
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FirRdyLogic_block
    USE ENTITY work_ltehdlDownlinkSyncDemod.LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FirRdyLogic_block(rtl);

  FOR ALL : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_Addressable_Delay_Line_block3
    USE ENTITY work_ltehdlDownlinkSyncDemod.LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_Addressable_Delay_Line_block3(rtl);

  FOR ALL : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FilterTapSystolic
    USE ENTITY work_ltehdlDownlinkSyncDemod.LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FilterTapSystolic(rtl);
...
BEGIN
  u_firRdyLogic : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FirRdyLogic_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine0 : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_Addressable_Delay_Line_block3
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              dataIn => dinSM,  -- ufix17
  ...
  u_delayLine1 : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_Addressable_Delay_Line_block3
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine2 : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_Addressable_Delay_Line_block3
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine3 : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_Addressable_Delay_Line_block3
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_filterTap0 : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FilterTapSystolic
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_filterTap1 : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FilterTapSystolic
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_filterTap2 : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FilterTapSystolic
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_filterTap3 : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FilterTapSystolic
    PORT MAP( clk => clk,
              enb => enb,
  ...
  BEGIN
    CASE rdAddr3 IS
      WHEN "00000" =>
        coeffTableOut3 <= to_signed(-16#38#, 8);
      WHEN "00001" =>
        coeffTableOut3 <= to_signed(-16#1D#, 8);
      WHEN "00010" =>
        coeffTableOut3 <= to_signed(16#10#, 8);
      WHEN "00011" =>
        coeffTableOut3 <= to_signed(16#15#, 8);
      WHEN "00100" =>
        coeffTableOut3 <= to_signed(-16#04#, 8);
      WHEN "00101" =>
        coeffTableOut3 <= to_signed(-16#0A#, 8);
      WHEN "00110" =>
        coeffTableOut3 <= to_signed(16#07#, 8);
      WHEN "00111" =>
        coeffTableOut3 <= to_signed(16#02#, 8);
      WHEN "01000" =>
        coeffTableOut3 <= to_signed(-16#1B#, 8);
      WHEN "01001" =>
        coeffTableOut3 <= to_signed(-16#1F#, 8);
      WHEN "01010" =>
        coeffTableOut3 <= to_signed(16#0B#, 8);
      WHEN "01011" =>
        coeffTableOut3 <= to_signed(16#31#, 8);
      WHEN "01100" =>
        coeffTableOut3 <= to_signed(16#26#, 8);
      WHEN "01101" =>
        coeffTableOut3 <= to_signed(-16#03#, 8);
      WHEN "01110" =>
        coeffTableOut3 <= to_signed(-16#1F#, 8);
      WHEN "01111" =>
        coeffTableOut3 <= to_signed(-16#26#, 8);
      WHEN "10000" =>
        coeffTableOut3 <= to_signed(-16#2A#, 8);
      WHEN "10001" =>
        coeffTableOut3 <= to_signed(-16#31#, 8);
      WHEN "10010" =>
        coeffTableOut3 <= to_signed(-16#33#, 8);
      WHEN "10011" =>
        coeffTableOut3 <= to_signed(-16#30#, 8);
      WHEN "10100" =>
        coeffTableOut3 <= to_signed(-16#2E#, 8);
      WHEN "10101" =>
        coeffTableOut3 <= to_signed(-16#2B#, 8);
      WHEN "10110" =>
        coeffTableOut3 <= to_signed(-16#20#, 8);
      WHEN "10111" =>
        coeffTableOut3 <= to_signed(-16#0B#, 8);
      WHEN "11000" =>
      ...
      WHEN "11101" =>
        coeffTableOut3 <= to_signed(-16#24#, 8);
      WHEN "11110" =>
        coeffTableOut3 <= to_signed(16#0A#, 8);
      WHEN "11111" =>
        coeffTableOut3 <= to_signed(16#26#, 8);
  ...
  BEGIN
    CASE rdAddr2 IS
      ...
      WHEN "00010" =>
        coeffTableOut2 <= to_signed(16#0A#, 8);
      WHEN "00011" =>
        coeffTableOut2 <= to_signed(16#01#, 8);
      WHEN "00100" =>
        coeffTableOut2 <= to_signed(16#25#, 8);
      WHEN "00101" =>
        coeffTableOut2 <= to_signed(16#43#, 8);
      WHEN "00110" =>
        coeffTableOut2 <= to_signed(16#18#, 8);
      WHEN "00111" =>
        coeffTableOut2 <= to_signed(-16#33#, 8);
      WHEN "01000" =>
        coeffTableOut2 <= to_signed(-16#37#, 8);
      WHEN "01001" =>
        coeffTableOut2 <= to_signed(16#08#, 8);
      WHEN "01010" =>
      ...
      WHEN "10000" =>
        coeffTableOut2 <= to_signed(-16#22#, 8);
      WHEN "10001" =>
        coeffTableOut2 <= to_signed(-16#35#, 8);
      WHEN "10010" =>
        coeffTableOut2 <= to_signed(-16#18#, 8);
      WHEN "10011" =>
        coeffTableOut2 <= to_signed(16#0D#, 8);
      WHEN "10100" =>
        coeffTableOut2 <= to_signed(16#22#, 8);
      WHEN "10101" =>
      ...
      WHEN "10110" =>
        coeffTableOut2 <= to_signed(16#2B#, 8);
      WHEN "10111" =>
        coeffTableOut2 <= to_signed(16#23#, 8);
      WHEN "11000" =>
        coeffTableOut2 <= to_signed(16#20#, 8);
      WHEN "11001" =>
        coeffTableOut2 <= to_signed(16#27#, 8);
      WHEN "11010" =>
        coeffTableOut2 <= to_signed(16#29#, 8);
      WHEN "11011" =>
        coeffTableOut2 <= to_signed(16#23#, 8);
      WHEN "11100" =>
        coeffTableOut2 <= to_signed(16#25#, 8);
      WHEN "11101" =>
        coeffTableOut2 <= to_signed(16#2C#, 8);
      WHEN "11110" =>
        coeffTableOut2 <= to_signed(16#19#, 8);
      WHEN "11111" =>
        coeffTableOut2 <= to_signed(-16#19#, 8);
      WHEN OTHERS => 
  ...
  BEGIN
    CASE rdAddr1 IS
      WHEN "00000" =>
        coeffTableOut1 <= to_signed(16#19#, 8);
      WHEN "00001" =>
        coeffTableOut1 <= to_signed(16#2C#, 8);
      WHEN "00010" =>
        coeffTableOut1 <= to_signed(16#25#, 8);
      WHEN "00011" =>
        coeffTableOut1 <= to_signed(16#23#, 8);
      WHEN "00100" =>
        coeffTableOut1 <= to_signed(16#29#, 8);
      WHEN "00101" =>
        coeffTableOut1 <= to_signed(16#27#, 8);
      WHEN "00110" =>
        coeffTableOut1 <= to_signed(16#20#, 8);
      WHEN "00111" =>
        coeffTableOut1 <= to_signed(16#23#, 8);
      WHEN "01000" =>
      ...
      WHEN "01001" =>
        coeffTableOut1 <= to_signed(16#2B#, 8);
      WHEN "01010" =>
        coeffTableOut1 <= to_signed(16#22#, 8);
      WHEN "01011" =>
        coeffTableOut1 <= to_signed(16#0D#, 8);
      WHEN "01100" =>
      ...
      WHEN "10101" =>
        coeffTableOut1 <= to_signed(16#08#, 8);
      WHEN "10110" =>
        coeffTableOut1 <= to_signed(-16#37#, 8);
      WHEN "10111" =>
        coeffTableOut1 <= to_signed(-16#33#, 8);
      WHEN "11000" =>
        coeffTableOut1 <= to_signed(16#18#, 8);
      WHEN "11001" =>
        coeffTableOut1 <= to_signed(16#43#, 8);
      WHEN "11010" =>
        coeffTableOut1 <= to_signed(16#25#, 8);
      WHEN "11011" =>
        coeffTableOut1 <= to_signed(16#01#, 8);
      WHEN "11100" =>
        coeffTableOut1 <= to_signed(16#0A#, 8);
      WHEN "11101" =>
  ...
  BEGIN
    CASE rdAddr0_1 IS
      WHEN "00000" =>
        coeffTableOut0 <= to_signed(16#0A#, 8);
      WHEN "00001" =>
        coeffTableOut0 <= to_signed(-16#24#, 8);
      WHEN "00010" =>
      ...
      WHEN "00111" =>
        coeffTableOut0 <= to_signed(-16#0B#, 8);
      WHEN "01000" =>
        coeffTableOut0 <= to_signed(-16#20#, 8);
      WHEN "01001" =>
        coeffTableOut0 <= to_signed(-16#2B#, 8);
      WHEN "01010" =>
        coeffTableOut0 <= to_signed(-16#2E#, 8);
      WHEN "01011" =>
        coeffTableOut0 <= to_signed(-16#30#, 8);
      WHEN "01100" =>
        coeffTableOut0 <= to_signed(-16#33#, 8);
      WHEN "01101" =>
        coeffTableOut0 <= to_signed(-16#31#, 8);
      WHEN "01110" =>
        coeffTableOut0 <= to_signed(-16#2A#, 8);
      WHEN "01111" =>
        coeffTableOut0 <= to_signed(-16#26#, 8);
      WHEN "10000" =>
        coeffTableOut0 <= to_signed(-16#1F#, 8);
      WHEN "10001" =>
        coeffTableOut0 <= to_signed(-16#03#, 8);
      WHEN "10010" =>
        coeffTableOut0 <= to_signed(16#26#, 8);
      WHEN "10011" =>
        coeffTableOut0 <= to_signed(16#31#, 8);
      ...
      WHEN "10111" =>
        coeffTableOut0 <= to_signed(16#02#, 8);
      WHEN "11000" =>
      ...
      WHEN "11011" =>
        coeffTableOut0 <= to_signed(16#15#, 8);
      WHEN "11100" =>
        coeffTableOut0 <= to_signed(16#10#, 8);
      WHEN "11101" =>
        coeffTableOut0 <= to_signed(-16#1D#, 8);
      WHEN "11110" =>
        coeffTableOut0 <= to_signed(-16#38#, 8);
      WHEN "11111" =>
        coeffTableOut0 <= to_signed(-16#19#, 8);
      WHEN OTHERS => 

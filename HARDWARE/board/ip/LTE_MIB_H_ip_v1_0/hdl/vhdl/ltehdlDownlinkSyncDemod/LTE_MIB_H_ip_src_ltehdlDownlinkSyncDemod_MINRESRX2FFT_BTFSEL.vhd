-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\zynqRadioHWSWLTEMIBDetectorRFSoC2x2\ltehdlDownlinkSyncDemod\LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_MINRESRX2FFT_BTFSEL.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_MINRESRX2FFT_BTFSEL
-- Source Path: ltehdlDownlinkSyncDemod/Sync Signal Search/SSS Searcher/FFT HDL Optimized/MINRESRX2FFT_BTFSEL
-- Hierarchy Level: 6
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_MINRESRX2FFT_BTFSEL IS
...
END LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_MINRESRX2FFT_BTFSEL;


ARCHITECTURE rtl OF LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_MINRESRX2FFT_BTFSEL IS

  -- Signals
  SIGNAL din_1_re_signed                  : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL din_1_im_signed                  : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL dMemOut1_re_signed               : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL dMemOut1_im_signed               : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL dMemOut2_re_signed               : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL dMemOut2_im_signed               : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL stage_unsigned                   : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL minResRX2FFTBTFSEL_btfIn1Reg_re  : signed(15 DOWNTO 0);  -- sfix16
  SIGNAL minResRX2FFTBTFSEL_btfIn1Reg_im  : signed(15 DOWNTO 0);  -- sfix16
  SIGNAL minResRX2FFTBTFSEL_btfIn2Reg_re  : signed(15 DOWNTO 0);  -- sfix16
  SIGNAL minResRX2FFTBTFSEL_btfIn2Reg_im  : signed(15 DOWNTO 0);  -- sfix16
  ...
  SIGNAL minResRX2FFTBTFSEL_dinReg1_re    : signed(15 DOWNTO 0);  -- sfix16
  SIGNAL minResRX2FFTBTFSEL_dinReg1_im    : signed(15 DOWNTO 0);  -- sfix16
  SIGNAL minResRX2FFTBTFSEL_dinReg2_re    : signed(15 DOWNTO 0);  -- sfix16
  SIGNAL minResRX2FFTBTFSEL_dinReg2_im    : signed(15 DOWNTO 0);  -- sfix16
  SIGNAL minResRX2FFTBTFSEL_dinReg3_re    : signed(15 DOWNTO 0);  -- sfix16
  SIGNAL minResRX2FFTBTFSEL_dinReg3_im    : signed(15 DOWNTO 0);  -- sfix16
  SIGNAL minResRX2FFTBTFSEL_dMemOut1Reg_re : signed(15 DOWNTO 0);  -- sfix16
  SIGNAL minResRX2FFTBTFSEL_dMemOut1Reg_im : signed(15 DOWNTO 0);  -- sfix16
  SIGNAL minResRX2FFTBTFSEL_dMemOut2Reg_re : signed(15 DOWNTO 0);  -- sfix16
  SIGNAL minResRX2FFTBTFSEL_dMemOut2Reg_im : signed(15 DOWNTO 0);  -- sfix16
  SIGNAL minResRX2FFTBTFSEL_dMemOutReg_vld : std_logic;
  SIGNAL minResRX2FFTBTFSEL_btfIn1Reg_re_next : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL minResRX2FFTBTFSEL_btfIn1Reg_im_next : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL minResRX2FFTBTFSEL_btfIn2Reg_re_next : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL minResRX2FFTBTFSEL_btfIn2Reg_im_next : signed(15 DOWNTO 0);  -- sfix16_En15
  ...
  SIGNAL minResRX2FFTBTFSEL_dinReg1_re_next : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL minResRX2FFTBTFSEL_dinReg1_im_next : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL minResRX2FFTBTFSEL_dinReg2_re_next : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL minResRX2FFTBTFSEL_dinReg2_im_next : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL minResRX2FFTBTFSEL_dinReg3_re_next : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL minResRX2FFTBTFSEL_dinReg3_im_next : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL minResRX2FFTBTFSEL_dMemOut1Reg_re_next : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL minResRX2FFTBTFSEL_dMemOut1Reg_im_next : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL minResRX2FFTBTFSEL_dMemOut2Reg_re_next : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL minResRX2FFTBTFSEL_dMemOut2Reg_im_next : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL minResRX2FFTBTFSEL_dMemOutReg_vld_next : std_logic;
  SIGNAL btfIn1_re_tmp                    : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL btfIn1_im_tmp                    : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL btfIn2_re_tmp                    : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL btfIn2_im_tmp                    : signed(15 DOWNTO 0);  -- sfix16_En15
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        minResRX2FFTBTFSEL_btfIn1Reg_re <= to_signed(16#0000#, 16);
        minResRX2FFTBTFSEL_btfIn1Reg_im <= to_signed(16#0000#, 16);
        minResRX2FFTBTFSEL_btfIn2Reg_re <= to_signed(16#0000#, 16);
        minResRX2FFTBTFSEL_btfIn2Reg_im <= to_signed(16#0000#, 16);
        minResRX2FFTBTFSEL_dinReg1_re <= to_signed(16#0000#, 16);
        minResRX2FFTBTFSEL_dinReg1_im <= to_signed(16#0000#, 16);
        minResRX2FFTBTFSEL_dinReg2_re <= to_signed(16#0000#, 16);
        minResRX2FFTBTFSEL_dinReg2_im <= to_signed(16#0000#, 16);
        minResRX2FFTBTFSEL_dinReg3_re <= to_signed(16#0000#, 16);
        minResRX2FFTBTFSEL_dinReg3_im <= to_signed(16#0000#, 16);
        minResRX2FFTBTFSEL_dMemOut1Reg_re <= to_signed(16#0000#, 16);
        minResRX2FFTBTFSEL_dMemOut1Reg_im <= to_signed(16#0000#, 16);
        minResRX2FFTBTFSEL_dMemOut2Reg_re <= to_signed(16#0000#, 16);
        minResRX2FFTBTFSEL_dMemOut2Reg_im <= to_signed(16#0000#, 16);

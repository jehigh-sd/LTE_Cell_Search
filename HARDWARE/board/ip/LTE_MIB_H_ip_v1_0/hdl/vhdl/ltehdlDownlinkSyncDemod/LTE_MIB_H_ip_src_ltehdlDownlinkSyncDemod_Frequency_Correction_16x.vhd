-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\zynqRadioHWSWLTEMIBDetectorRFSoC2x2\ltehdlDownlinkSyncDemod\LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_Frequency_Correction_16x.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_Frequency_Correction_16x
-- Source Path: ltehdlDownlinkSyncDemod/Frequency Correction 16x
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_Frequency_Correction_16x IS
...
END LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_Frequency_Correction_16x;


ARCHITECTURE rtl OF LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_Frequency_Correction_16x IS

  -- Component Declarations
  COMPONENT LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_NCO_HDL_Optimized1
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb_1_2_0                       :   IN    std_logic;
  ...
  FOR ALL : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_NCO_HDL_Optimized1
    USE ENTITY work_ltehdlDownlinkSyncDemod.LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_NCO_HDL_Optimized1(rtl);
...
BEGIN
  ...
  u_NCO_HDL_Optimized1 : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_NCO_HDL_Optimized1
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb_1_2_0 => enb_1_2_0,
              inc => std_logic_vector(inc3),  -- ufix14
              validIn => Delay12_out1_1,

-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\zynqRadioHWSWLTEMIBDetectorRFSoC2x2\ltehdlDownlinkSyncDemod\LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_MINRESRX2FFT_OUTMux.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_MINRESRX2FFT_OUTMux
-- Source Path: ltehdlDownlinkSyncDemod/Sync Signal Search/SSS Searcher/FFT HDL Optimized/MINRESRX2FFT_OUTMux
-- Hierarchy Level: 6
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_MINRESRX2FFT_OUTMux IS
...
END LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_MINRESRX2FFT_OUTMux;


ARCHITECTURE rtl OF LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_MINRESRX2FFT_OUTMux IS
  ...
  SIGNAL minResRX2FFTOutMux_doutReg_re    : signed(15 DOWNTO 0);  -- sfix16
  SIGNAL minResRX2FFTOutMux_doutReg_im    : signed(15 DOWNTO 0);  -- sfix16
  ...
  SIGNAL minResRX2FFTOutMux_doutReg_re_next : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL minResRX2FFTOutMux_doutReg_im_next : signed(15 DOWNTO 0);  -- sfix16_En15
  ...
  SIGNAL dOut_re_tmp                      : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL dOut_im_tmp                      : signed(15 DOWNTO 0);  -- sfix16_En15
...
BEGIN
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        minResRX2FFTOutMux_doutReg_re <= to_signed(16#0000#, 16);
        minResRX2FFTOutMux_doutReg_im <= to_signed(16#0000#, 16);

-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\zynqRadioHWSWLTEMIBDetectorRFSoC2x2\ltehdlDownlinkSyncDemod\LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FirRdyLogic_block2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FirRdyLogic_block2
-- Source Path: ltehdlDownlinkSyncDemod/Sync Signal Search/PSS Searcher/Correlators/PSSXCorr0/C-D/FirRdyLogic
-- Hierarchy Level: 8
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FirRdyLogic_block2 IS
...
END LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FirRdyLogic_block2;


ARCHITECTURE rtl OF LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FirRdyLogic_block2 IS
  ...
  SIGNAL firRdy_xdin                      : signed(15 DOWNTO 0);  -- sfix16
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        ...
        firRdy_xdin <= to_signed(16#0000#, 16);
        firRdy_xdinVld <= '0';
        firRdy_readyReg <= '1';

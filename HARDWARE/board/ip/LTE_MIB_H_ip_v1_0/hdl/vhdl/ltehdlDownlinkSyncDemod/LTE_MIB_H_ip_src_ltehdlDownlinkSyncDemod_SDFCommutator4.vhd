-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\zynqRadioHWSWLTEMIBDetectorRFSoC2x2\ltehdlDownlinkSyncDemod\LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_SDFCommutator4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_SDFCommutator4
-- Source Path: ltehdlDownlinkSyncDemod/OFDM Demodulation/FFT HDL Optimized/RADIX22FFT_SDF2_4/SDFCommutator4
-- Hierarchy Level: 6
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_SDFCommutator4 IS
...
END LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_SDFCommutator4;


ARCHITECTURE rtl OF LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_SDFCommutator4 IS
...
BEGIN
  u_dataXMEM_re_0_4 : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_SimpleDualPortRAM_generic_block
  ...
  u_dataXMEM_im_0_4 : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_SimpleDualPortRAM_generic_block
    GENERIC MAP( AddrWidth => 3,
                 DataWidth => 20
                 )
    PORT MAP( clk => clk,

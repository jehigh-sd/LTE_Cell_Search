-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\zynqRadioHWSWLTEMIBDetectorRFSoC2x2\ltehdlDownlinkSyncDemod\LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_C_D_block4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_C_D_block4
-- Source Path: ltehdlDownlinkSyncDemod/Sync Signal Search/PSS Searcher/Correlators/PSSXCorr2/C-D
-- Hierarchy Level: 7
-- 
-- Discrete FIR Filter
-- 
...
ENTITY LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_C_D_block4 IS
...
END LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_C_D_block4;


ARCHITECTURE rtl OF LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_C_D_block4 IS

  -- Component Declarations
  COMPONENT LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FirRdyLogic_block8
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  COMPONENT LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_Addressable_Delay_Line_block11
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  COMPONENT LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FilterTapSystolic_block7
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FirRdyLogic_block8
    USE ENTITY work_ltehdlDownlinkSyncDemod.LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FirRdyLogic_block8(rtl);

  FOR ALL : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_Addressable_Delay_Line_block11
    USE ENTITY work_ltehdlDownlinkSyncDemod.LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_Addressable_Delay_Line_block11(rtl);

  FOR ALL : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FilterTapSystolic_block7
    USE ENTITY work_ltehdlDownlinkSyncDemod.LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FilterTapSystolic_block7(rtl);
...
BEGIN
  u_firRdyLogic : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FirRdyLogic_block8
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine0 : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_Addressable_Delay_Line_block11
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              dataIn => dinSM,  -- ufix16
  ...
  u_delayLine1 : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_Addressable_Delay_Line_block11
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine2 : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_Addressable_Delay_Line_block11
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine3 : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_Addressable_Delay_Line_block11
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_filterTap0 : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FilterTapSystolic_block7
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_filterTap1 : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FilterTapSystolic_block7
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_filterTap2 : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FilterTapSystolic_block7
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_filterTap3 : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FilterTapSystolic_block7
    PORT MAP( clk => clk,
              enb => enb,
  ...
  BEGIN
    CASE rdAddr3 IS
      ...
      WHEN "00001" =>
        coeffTableOut3 <= to_signed(16#016#, 9);
      WHEN "00010" =>
        coeffTableOut3 <= to_signed(-16#00D#, 9);
      WHEN "00011" =>
      ...
      WHEN "00111" =>
        coeffTableOut3 <= to_signed(-16#022#, 9);
      WHEN "01000" =>
        coeffTableOut3 <= to_signed(-16#03F#, 9);
      WHEN "01001" =>
        coeffTableOut3 <= to_signed(-16#032#, 9);
      WHEN "01010" =>
        coeffTableOut3 <= to_signed(-16#00B#, 9);
      WHEN "01011" =>
        coeffTableOut3 <= to_signed(-16#001#, 9);
      WHEN "01100" =>
        coeffTableOut3 <= to_signed(-16#014#, 9);
      WHEN "01101" =>
        coeffTableOut3 <= to_signed(-16#011#, 9);
      WHEN "01110" =>
        coeffTableOut3 <= to_signed(16#01B#, 9);
      WHEN "01111" =>
        coeffTableOut3 <= to_signed(16#042#, 9);
      WHEN "10000" =>
      ...
      WHEN "10011" =>
        coeffTableOut3 <= to_signed(16#018#, 9);
      WHEN "10100" =>
        coeffTableOut3 <= to_signed(-16#024#, 9);
      WHEN "10101" =>
        coeffTableOut3 <= to_signed(-16#043#, 9);
      WHEN "10110" =>
        coeffTableOut3 <= to_signed(-16#014#, 9);
      WHEN "10111" =>
        coeffTableOut3 <= to_signed(16#03B#, 9);
      WHEN "11000" =>
        coeffTableOut3 <= to_signed(16#051#, 9);
      WHEN "11001" =>
        coeffTableOut3 <= to_signed(16#025#, 9);
      WHEN "11010" =>
  ...
  BEGIN
    CASE rdAddr2 IS
      WHEN "00000" =>
        coeffTableOut2 <= to_signed(16#033#, 9);
      WHEN "00001" =>
        coeffTableOut2 <= to_signed(16#016#, 9);
      WHEN "00010" =>
        coeffTableOut2 <= to_signed(-16#015#, 9);
      WHEN "00011" =>
        coeffTableOut2 <= to_signed(-16#027#, 9);
      WHEN "00100" =>
        coeffTableOut2 <= to_signed(-16#014#, 9);
      WHEN "00101" =>
        coeffTableOut2 <= to_signed(-16#00A#, 9);
      WHEN "00110" =>
      ...
      WHEN "01011" =>
        coeffTableOut2 <= to_signed(-16#032#, 9);
      WHEN "01100" =>
        coeffTableOut2 <= to_signed(-16#046#, 9);
      WHEN "01101" =>
        coeffTableOut2 <= to_signed(-16#004#, 9);
      WHEN "01110" =>
        coeffTableOut2 <= to_signed(16#02B#, 9);
      WHEN "01111" =>
        coeffTableOut2 <= to_signed(16#006#, 9);
      WHEN "10000" =>
        coeffTableOut2 <= to_signed(-16#038#, 9);
      WHEN "10001" =>
        coeffTableOut2 <= to_signed(-16#048#, 9);
      WHEN "10010" =>
        coeffTableOut2 <= to_signed(-16#035#, 9);
      WHEN "10011" =>
        coeffTableOut2 <= to_signed(-16#033#, 9);
      WHEN "10100" =>
        coeffTableOut2 <= to_signed(-16#03E#, 9);
      WHEN "10101" =>
      ...
      WHEN "11001" =>
        coeffTableOut2 <= to_signed(16#023#, 9);
      WHEN "11010" =>
        coeffTableOut2 <= to_signed(16#02E#, 9);
      WHEN "11011" =>
        coeffTableOut2 <= to_signed(16#01D#, 9);
      WHEN "11100" =>
        coeffTableOut2 <= to_signed(16#005#, 9);
      WHEN "11101" =>
        coeffTableOut2 <= to_signed(16#005#, 9);
      WHEN "11110" =>
  ...
  BEGIN
    CASE rdAddr1 IS
      ...
      WHEN "00001" =>
        coeffTableOut1 <= to_signed(16#005#, 9);
      WHEN "00010" =>
        coeffTableOut1 <= to_signed(16#005#, 9);
      WHEN "00011" =>
        coeffTableOut1 <= to_signed(16#01D#, 9);
      WHEN "00100" =>
        coeffTableOut1 <= to_signed(16#02E#, 9);
      WHEN "00101" =>
        coeffTableOut1 <= to_signed(16#023#, 9);
      WHEN "00110" =>
        coeffTableOut1 <= to_signed(16#00D#, 9);
      WHEN "00111" =>
        coeffTableOut1 <= to_signed(-16#004#, 9);
      WHEN "01000" =>
        coeffTableOut1 <= to_signed(-16#01C#, 9);
      WHEN "01001" =>
        coeffTableOut1 <= to_signed(-16#037#, 9);
      WHEN "01010" =>
        coeffTableOut1 <= to_signed(-16#03E#, 9);
      WHEN "01011" =>
        coeffTableOut1 <= to_signed(-16#033#, 9);
      WHEN "01100" =>
        coeffTableOut1 <= to_signed(-16#035#, 9);
      WHEN "01101" =>
        coeffTableOut1 <= to_signed(-16#048#, 9);
      WHEN "01110" =>
        coeffTableOut1 <= to_signed(-16#038#, 9);
      WHEN "01111" =>
        coeffTableOut1 <= to_signed(16#006#, 9);
      WHEN "10000" =>
        coeffTableOut1 <= to_signed(16#02B#, 9);
      WHEN "10001" =>
        coeffTableOut1 <= to_signed(-16#004#, 9);
      WHEN "10010" =>
        coeffTableOut1 <= to_signed(-16#046#, 9);
      WHEN "10011" =>
        coeffTableOut1 <= to_signed(-16#032#, 9);
      WHEN "10100" =>
      ...
      WHEN "11001" =>
        coeffTableOut1 <= to_signed(-16#00A#, 9);
      WHEN "11010" =>
        coeffTableOut1 <= to_signed(-16#014#, 9);
      WHEN "11011" =>
        coeffTableOut1 <= to_signed(-16#027#, 9);
      WHEN "11100" =>
      ...
      WHEN "11110" =>
        coeffTableOut1 <= to_signed(16#033#, 9);
      WHEN "11111" =>
        coeffTableOut1 <= to_signed(16#03A#, 9);
      WHEN OTHERS => 
  ...
  BEGIN
    CASE rdAddr0_1 IS
      WHEN "00000" =>
        coeffTableOut0 <= to_signed(-16#014#, 9);
      WHEN "00001" =>
        coeffTableOut0 <= to_signed(16#039#, 9);
      WHEN "00010" =>
        coeffTableOut0 <= to_signed(16#051#, 9);
      WHEN "00011" =>
      ...
      WHEN "01000" =>
        coeffTableOut0 <= to_signed(-16#014#, 9);
      WHEN "01001" =>
        coeffTableOut0 <= to_signed(-16#043#, 9);
      WHEN "01010" =>
      ...
      WHEN "01111" =>
        coeffTableOut0 <= to_signed(16#042#, 9);
      WHEN "10000" =>
        coeffTableOut0 <= to_signed(16#01B#, 9);
      WHEN "10001" =>
        coeffTableOut0 <= to_signed(-16#011#, 9);
      WHEN "10010" =>
        coeffTableOut0 <= to_signed(-16#014#, 9);
      WHEN "10011" =>
        coeffTableOut0 <= to_signed(-16#001#, 9);
      WHEN "10100" =>
        coeffTableOut0 <= to_signed(-16#00B#, 9);
      WHEN "10101" =>
        coeffTableOut0 <= to_signed(-16#032#, 9);
      WHEN "10110" =>
        coeffTableOut0 <= to_signed(-16#03F#, 9);
      WHEN "10111" =>
        coeffTableOut0 <= to_signed(-16#022#, 9);
      WHEN "11000" =>
      ...
      WHEN "11100" =>
        coeffTableOut0 <= to_signed(-16#00D#, 9);
      WHEN "11101" =>
        coeffTableOut0 <= to_signed(16#016#, 9);
      WHEN "11110" =>
        coeffTableOut0 <= to_signed(16#028#, 9);
      WHEN "11111" =>
        coeffTableOut0 <= to_signed(16#02A#, 9);
      WHEN OTHERS => 

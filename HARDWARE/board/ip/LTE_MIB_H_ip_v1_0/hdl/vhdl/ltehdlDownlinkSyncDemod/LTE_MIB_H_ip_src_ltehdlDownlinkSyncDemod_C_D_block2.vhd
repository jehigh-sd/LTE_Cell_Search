-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\zynqRadioHWSWLTEMIBDetectorRFSoC2x2\ltehdlDownlinkSyncDemod\LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_C_D_block2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_C_D_block2
...
ENTITY LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_C_D_block2 IS
...
END LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_C_D_block2;


ARCHITECTURE rtl OF LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_C_D_block2 IS

  -- Component Declarations
  COMPONENT LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FirRdyLogic_block5
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  COMPONENT LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_Addressable_Delay_Line_block8
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  COMPONENT LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FilterTapSystolic_block4
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FirRdyLogic_block5
    USE ENTITY work_ltehdlDownlinkSyncDemod.LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FirRdyLogic_block5(rtl);

  FOR ALL : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_Addressable_Delay_Line_block8
    USE ENTITY work_ltehdlDownlinkSyncDemod.LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_Addressable_Delay_Line_block8(rtl);

  FOR ALL : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FilterTapSystolic_block4
    USE ENTITY work_ltehdlDownlinkSyncDemod.LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FilterTapSystolic_block4(rtl);
...
BEGIN
  u_firRdyLogic : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FirRdyLogic_block5
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine0 : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_Addressable_Delay_Line_block8
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              dataIn => dinSM,  -- ufix16
  ...
  u_delayLine1 : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_Addressable_Delay_Line_block8
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine2 : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_Addressable_Delay_Line_block8
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_delayLine3 : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_Addressable_Delay_Line_block8
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_filterTap0 : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FilterTapSystolic_block4
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_filterTap1 : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FilterTapSystolic_block4
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_filterTap2 : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FilterTapSystolic_block4
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_filterTap3 : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FilterTapSystolic_block4
    PORT MAP( clk => clk,
              enb => enb,

-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\zynqRadioHWSWLTEMIBDetectorRFSoC2x2\ltehdlPBCHDecoder\LTE_MIB_H_ip_src_ltehdlPBCHDecoder_SimpleDualPortRAM_generic.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LTE_MIB_H_ip_src_ltehdlPBCHDecoder_SimpleDualPortRAM_generic
-- Source Path: ltehdlPBCHDecoder/SimpleDualPortRAM_generic
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY LTE_MIB_H_ip_src_ltehdlPBCHDecoder_SimpleDualPortRAM_generic IS
...
END LTE_MIB_H_ip_src_ltehdlPBCHDecoder_SimpleDualPortRAM_generic;


ARCHITECTURE rtl OF LTE_MIB_H_ip_src_ltehdlPBCHDecoder_SimpleDualPortRAM_generic IS

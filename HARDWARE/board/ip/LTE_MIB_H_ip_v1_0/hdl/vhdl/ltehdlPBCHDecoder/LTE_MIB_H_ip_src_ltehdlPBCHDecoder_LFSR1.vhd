-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\zynqRadioHWSWLTEMIBDetectorRFSoC2x2\ltehdlPBCHDecoder\LTE_MIB_H_ip_src_ltehdlPBCHDecoder_LFSR1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LTE_MIB_H_ip_src_ltehdlPBCHDecoder_LFSR1
-- Source Path: ltehdlPBCHDecoder/Gold Sequence Generator/LFSR1
-- Hierarchy Level: 5
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY LTE_MIB_H_ip_src_ltehdlPBCHDecoder_LFSR1 IS
...
END LTE_MIB_H_ip_src_ltehdlPBCHDecoder_LFSR1;


ARCHITECTURE rtl OF LTE_MIB_H_ip_src_ltehdlPBCHDecoder_LFSR1 IS

  -- Component Declarations
  COMPONENT LTE_MIB_H_ip_src_ltehdlPBCHDecoder_MATLAB_Function
  ...
  FOR ALL : LTE_MIB_H_ip_src_ltehdlPBCHDecoder_MATLAB_Function
    USE ENTITY work_ltehdlPBCHDecoder.LTE_MIB_H_ip_src_ltehdlPBCHDecoder_MATLAB_Function(rtl);
...
BEGIN
  u_MATLAB_Function : LTE_MIB_H_ip_src_ltehdlPBCHDecoder_MATLAB_Function

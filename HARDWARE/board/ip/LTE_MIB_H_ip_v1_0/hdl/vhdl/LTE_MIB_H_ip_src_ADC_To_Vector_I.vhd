-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\zynqRadioHWSWLTEMIBDetectorRFSoC2x2\LTE_MIB_H_ip_src_ADC_To_Vector_I.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LTE_MIB_H_ip_src_ADC_To_Vector_I
-- Source Path: zynqRadioHWSWLTEMIBDetectorRFSoC2x2/LTE_MIB_HDL/Preprocessor/Vector Decimator/ADC To Vector I
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY LTE_MIB_H_ip_src_ADC_To_Vector_I IS
...
END LTE_MIB_H_ip_src_ADC_To_Vector_I;


ARCHITECTURE rtl OF LTE_MIB_H_ip_src_ADC_To_Vector_I IS

  -- Component Declarations
  COMPONENT LTE_MIB_H_ip_src_Unpack_into_vector_v2
    PORT( packed_in                       :   IN    std_logic_vector(127 DOWNTO 0);  -- ufix128
  ...
  FOR ALL : LTE_MIB_H_ip_src_Unpack_into_vector_v2
    USE ENTITY work.LTE_MIB_H_ip_src_Unpack_into_vector_v2(rtl);
...
BEGIN
  u_Unpack_into_vector_v2 : LTE_MIB_H_ip_src_Unpack_into_vector_v2

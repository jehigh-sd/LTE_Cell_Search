-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\zynqRadioHWSWLTEMIBDetectorRFSoC2x2\LTE_MIB_H_ip_src_FilterCoef_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LTE_MIB_H_ip_src_FilterCoef_block1
...
ENTITY LTE_MIB_H_ip_src_FilterCoef_block1 IS
...
END LTE_MIB_H_ip_src_FilterCoef_block1;


ARCHITECTURE rtl OF LTE_MIB_H_ip_src_FilterCoef_block1 IS
...
BEGIN
  ...
  -- CoefReg_2
  CoefData_1 <= to_signed(-16#091E#, 16);

  CoefOut_1 <= std_logic_vector(CoefData_1);

  -- CoefReg_3
  CoefData_2 <= to_signed(-16#142A#, 16);

  CoefOut_2 <= std_logic_vector(CoefData_2);

  -- CoefReg_4
  CoefData_3 <= to_signed(16#022B#, 16);

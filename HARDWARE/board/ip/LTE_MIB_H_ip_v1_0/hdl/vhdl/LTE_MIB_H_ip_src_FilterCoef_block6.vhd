-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\zynqRadioHWSWLTEMIBDetectorRFSoC2x2\LTE_MIB_H_ip_src_FilterCoef_block6.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LTE_MIB_H_ip_src_FilterCoef_block6
...
ENTITY LTE_MIB_H_ip_src_FilterCoef_block6 IS
...
END LTE_MIB_H_ip_src_FilterCoef_block6;


ARCHITECTURE rtl OF LTE_MIB_H_ip_src_FilterCoef_block6 IS
...
BEGIN
  ...
  -- CoefReg_2
  CoefData_1 <= to_signed(-16#0268#, 16);
  ...
  -- CoefReg_4
  CoefData_3 <= to_signed(16#0894#, 16);

  CoefOut_3 <= std_logic_vector(CoefData_3);

  -- CoefReg_5
  CoefData_4 <= to_signed(-16#007B#, 16);

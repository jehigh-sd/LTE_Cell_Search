-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\zynqRadioHWSWLTEMIBDetectorRFSoC2x2\LTE_MIB_H_ip_src_Decimation.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LTE_MIB_H_ip_src_Decimation
-- Source Path: zynqRadioHWSWLTEMIBDetectorRFSoC2x2/LTE_MIB_HDL/Preprocessor/Vector Decimator/Decimation
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY LTE_MIB_H_ip_src_Decimation IS
...
END LTE_MIB_H_ip_src_Decimation;


ARCHITECTURE rtl OF LTE_MIB_H_ip_src_Decimation IS

  -- Component Declarations
  COMPONENT LTE_MIB_H_ip_src_FIR_Decimation_HDL_Optimized1
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : LTE_MIB_H_ip_src_FIR_Decimation_HDL_Optimized1
    USE ENTITY work.LTE_MIB_H_ip_src_FIR_Decimation_HDL_Optimized1(rtl);
...
BEGIN
  u_FIR_Decimation_HDL_Optimized1 : LTE_MIB_H_ip_src_FIR_Decimation_HDL_Optimized1
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,

-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\zynqRadioHWSWLTEMIBDetectorRFSoC2x2\LTE_MIB_H_ip_src_subFilter_block4.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LTE_MIB_H_ip_src_subFilter_block4
...
ENTITY LTE_MIB_H_ip_src_subFilter_block4 IS
...
END LTE_MIB_H_ip_src_subFilter_block4;


ARCHITECTURE rtl OF LTE_MIB_H_ip_src_subFilter_block4 IS

  -- Component Declarations
  COMPONENT LTE_MIB_H_ip_src_FilterTapSystolicWvldin_block4
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
          dinReg2_5_re                    :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En15
          coefIn_0                        :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En16
  ...
  FOR ALL : LTE_MIB_H_ip_src_FilterTapSystolicWvldin_block4
    USE ENTITY work.LTE_MIB_H_ip_src_FilterTapSystolicWvldin_block4(rtl);
  ...
  SIGNAL dout_6_re_tmp                    : signed(32 DOWNTO 0);  -- sfix33_En31

BEGIN
  u_FilterTap_1 : LTE_MIB_H_ip_src_FilterTapSystolicWvldin_block4
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_2 : LTE_MIB_H_ip_src_FilterTapSystolicWvldin_block4
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_5_re => dinDly2,  -- sfix16_En15
  ...
  u_FilterTap_3 : LTE_MIB_H_ip_src_FilterTapSystolicWvldin_block4
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_5_re => dinDly2_1,  -- sfix16_En15
  ...
  u_FilterTap_4 : LTE_MIB_H_ip_src_FilterTapSystolicWvldin_block4
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_5_re => dinDly2_2,  -- sfix16_En15
  ...
  u_FilterTap_5 : LTE_MIB_H_ip_src_FilterTapSystolicWvldin_block4
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_5_re => dinDly2_3,  -- sfix16_En15

-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\zynqRadioHWSWLTEMIBDetectorRFSoC2x2\LTE_MIB_H_ip_src_subFilter_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LTE_MIB_H_ip_src_subFilter_block
...
ENTITY LTE_MIB_H_ip_src_subFilter_block IS
...
END LTE_MIB_H_ip_src_subFilter_block;


ARCHITECTURE rtl OF LTE_MIB_H_ip_src_subFilter_block IS

  -- Component Declarations
  COMPONENT LTE_MIB_H_ip_src_FilterTapSystolicWvldin_block
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
          dinReg2_1_re                    :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En15
          coefIn_0                        :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En16
  ...
  COMPONENT LTE_MIB_H_ip_src_FilterTapSystolicWvldInC0_block
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
          dinReg2_1_re                    :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En15
          addin                           :   IN    std_logic_vector(47 DOWNTO 0);  -- sfix48_En31
  ...
  FOR ALL : LTE_MIB_H_ip_src_FilterTapSystolicWvldin_block
    USE ENTITY work.LTE_MIB_H_ip_src_FilterTapSystolicWvldin_block(rtl);

  FOR ALL : LTE_MIB_H_ip_src_FilterTapSystolicWvldInC0_block
    USE ENTITY work.LTE_MIB_H_ip_src_FilterTapSystolicWvldInC0_block(rtl);
...
BEGIN
  u_FilterTap_1 : LTE_MIB_H_ip_src_FilterTapSystolicWvldin_block
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_2 : LTE_MIB_H_ip_src_FilterTapSystolicWvldin_block
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_3 : LTE_MIB_H_ip_src_FilterTapSystolicWvldin_block
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_4 : LTE_MIB_H_ip_src_FilterTapSystolicWvldin_block
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_5 : LTE_MIB_H_ip_src_FilterTapSystolicWvldInC0_block
    PORT MAP( clk => clk,
              enb => enb,

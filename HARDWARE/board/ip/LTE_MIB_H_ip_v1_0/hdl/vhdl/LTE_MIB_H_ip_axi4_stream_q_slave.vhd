-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\zynqRadioHWSWLTEMIBDetectorRFSoC2x2\LTE_MIB_H_ip_axi4_stream_q_slave.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LTE_MIB_H_ip_axi4_stream_q_slave
-- Source Path: LTE_MIB_H_ip/LTE_MIB_H_ip_axi4_stream_q_slave
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY LTE_MIB_H_ip_axi4_stream_q_slave IS
...
END LTE_MIB_H_ip_axi4_stream_q_slave;


ARCHITECTURE rtl OF LTE_MIB_H_ip_axi4_stream_q_slave IS

  -- Component Declarations
  COMPONENT LTE_MIB_H_ip_fifo_data_block
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : LTE_MIB_H_ip_fifo_data_block
    USE ENTITY work.LTE_MIB_H_ip_fifo_data_block(rtl);
...
BEGIN
  u_LTE_MIB_H_ip_fifo_data_inst : LTE_MIB_H_ip_fifo_data_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              In_rsvd => AXI4_Stream_Q_Slave_TDATA,  -- ufix128
              Push => AXI4_Stream_Q_Slave_TVALID,  -- ufix1
  ...
  AXI4_Stream_Q_Slave_TREADY <=  NOT fifo_full;

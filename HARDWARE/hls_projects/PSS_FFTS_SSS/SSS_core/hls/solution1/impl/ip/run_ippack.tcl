...
set IPName      "sss_corr"
set Version     "1.0"
set DisplayName "Sss_corr"
set Revision    "2112532123"
...
set xo_kernel_name "sss_corr"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/jhigh/Capstone_Project/main/HARDWARE/HLS_Pjts/PSS_FFTS_SSS/SSS_core/hls/solution1"
set debug_dir "/home/jhigh/Capstone_Project/main/HARDWARE/HLS_Pjts/PSS_FFTS_SSS/SSS_core/hls/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {sss_corr_faddfsub_32ns_32ns_32_3_full_dsp_1
...
set Interfaces {
    ...
    s_axi_control_r {
        ...
        registers {{0x10 OUT1_1 W 0x0 "Data signal of OUT1" {{0 32 OUT1 W 0 "Bit 31 to 0 of OUT1"}}} {0x14 OUT1_2 W 0x0 "Data signal of OUT1" {{0 32 OUT1 W 0 "Bit 63 to 32 of OUT1"}}} {0x1c OUT2_1 W 0x0 "Data signal of OUT2" {{0 32 OUT2 W 0 "Bit 31 to 0 of OUT2"}}} {0x20 OUT2_2 W 0x0 "Data signal of OUT2" {{0 32 OUT2 W 0 "Bit 63 to 32 of OUT2"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_control s_axi_control_r m_axi_gmem IN_R IN_I pss_id"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 16 machine 64 combinational 0 latency 476 II x}

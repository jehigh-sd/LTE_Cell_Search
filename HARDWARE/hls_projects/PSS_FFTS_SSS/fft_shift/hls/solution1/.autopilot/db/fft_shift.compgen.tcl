...
set ID 11
set hasByteEnable 0
set MemName fft_shift_in_temp_r
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 12 \
			corename fft_shift_control_axilite \
			name fft_shift_control_s_axi \
			ports {$port_control} \
			op interface \
			is_flushable 0 \ 
			is_datawidth64 0 \ 
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler fft_shift_control_s_axi
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { OUT_I_TVALID { O 1 bit } OUT_I_TREADY { I 1 bit } OUT_I_TLAST { O 1 vector } } \
} "
} else {
...
# RegSlice definition:
set ID 25
set RegSliceName fft_shift_regslice_both
set RegSliceInstName fft_shift_regslice_both_U
set CoreName ap_simcore_fft_shift_regslice_both
if {${::AESL::PGuard_rtl_comp_handler}} {

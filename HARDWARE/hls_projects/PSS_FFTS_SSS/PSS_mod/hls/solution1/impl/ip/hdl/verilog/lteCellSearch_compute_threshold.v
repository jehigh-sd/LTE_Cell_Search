...
wire   [63:0] zext_ln256_fu_242_p1;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state5)) begin
        ...
        trunc_ln7_reg_508 <= {{r_V_fu_299_p2[42:20]}};
    end
end
...
always @ (*) begin
    if ((~((trunc_ln264_out_full_n == 1'b0) | (trunc_ln264_empty_n == 1'b0) | (ap_done_reg == 1'b1) | (ap_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        IN_imag_V_ce0 = 1'b1;
    end else begin
        IN_imag_V_ce0 = 1'b0;
    end
...
assign IN_imag_V_address0 = zext_ln256_fu_242_p1;

assign IN_real_V_address0 = zext_ln256_fu_242_p1;
...
always @ (*) begin
    ap_block_state1 = ((trunc_ln264_out_full_n == 1'b0) | (trunc_ln264_empty_n == 1'b0) | (ap_done_reg == 1'b1) | (ap_start == 1'b0));
end
...
assign run_fu_248_p2 = ((trunc_ln264_dout == 17'd0) ? 1'b1 : 1'b0);
...
assign sext_ln1118_3_fu_406_p1 = $signed(trunc_ln7_reg_508);
...
assign trunc_ln264_out_din = trunc_ln264_dout;
...
assign zext_ln256_fu_242_p1 = trunc_ln264_dout;

...
set Library     "hls"
set IPName      "lteCellSearch"
set Version     "1.0"
set DisplayName "Ltecellsearch"
set Revision    "2112532109"
...
set xo_kernel_name "lteCellSearch"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/jhigh/Capstone_Project/main/HARDWARE/HLS_Pjts/PSS_FFTS_SSS/PSS_mod/hls/solution1"
set debug_dir "/home/jhigh/Capstone_Project/main/HARDWARE/HLS_Pjts/PSS_FFTS_SSS/PSS_mod/hls/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {lteCellSearch_mul_23s_20ns_43_1_1
...
lteCellSearch_fifo_w17_d2_S
lteCellSearch_fifo_w17_d2_S
lteCellSearch_fifo_w17_d2_S
lteCellSearch_fifo_w32_d2_S
lteCellSearch_fifo_w20_d2_S
lteCellSearch_fifo_w20_d2_S
lteCellSearch_fifo_w20_d2_S
...
## Variables
set Top "lteCellSearch"
set TopNoPrefix "lteCellSearch"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 OUT_PSS_ID R 0x0 "Data signal of OUT_PSS_ID" {{0 32 OUT_PSS_ID R 0 "Bit 31 to 0 of OUT_PSS_ID"}}} {0x14 OUT_PSS_ID_ctrl R 0x0 "Control signal of OUT_PSS_ID" {{0 1 OUT_PSS_ID_ap_vld R 0 "Control signal OUT_PSS_ID_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 OUT_PEAK_INDEX R 0x0 "Data signal of OUT_PEAK_INDEX" {{0 32 OUT_PEAK_INDEX R 0 "Bit 31 to 0 of OUT_PEAK_INDEX"}}} {0x24 OUT_PEAK_INDEX_ctrl R 0x0 "Control signal of OUT_PEAK_INDEX" {{0 1 OUT_PEAK_INDEX_ap_vld R 0 "Control signal OUT_PEAK_INDEX_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x30 OUT_RSLT_1 W 0x0 "Data signal of OUT_RSLT" {{0 32 OUT_RSLT W 0 "Bit 31 to 0 of OUT_RSLT"}}} {0x34 OUT_RSLT_2 W 0x0 "Data signal of OUT_RSLT" {{0 32 OUT_RSLT W 0 "Bit 63 to 32 of OUT_RSLT"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_control m_axi_gmem IN_R IN_I OUT_FFT pss_id"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 16.3 machine 64 combinational 0 latency undef II x}

...
wire   [63:0] zext_ln256_fu_550_p1;
...
always @ (*) begin
    if ((~((trunc_ln264_empty_n == 1'b0) | (ap_done_reg == 1'b1) | (ap_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        IN_imag_V_ce1 = 1'b1;
    end else begin
        IN_imag_V_ce1 = 1'b0;
    end
...
assign IN_imag_V_address1 = zext_ln256_fu_550_p1;

assign IN_real_V_address1 = zext_ln256_fu_550_p1;
...
always @ (*) begin
    ap_block_state1 = ((trunc_ln264_empty_n == 1'b0) | (ap_done_reg == 1'b1) | (ap_start == 1'b0));
end
...
assign run_fu_556_p2 = ((trunc_ln264_dout == 17'd0) ? 1'b1 : 1'b0);
...
assign zext_ln256_fu_550_p1 = trunc_ln264_dout;

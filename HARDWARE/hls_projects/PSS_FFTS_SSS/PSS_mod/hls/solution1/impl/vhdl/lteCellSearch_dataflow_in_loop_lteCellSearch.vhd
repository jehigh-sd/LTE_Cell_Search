...
attribute shreg_extract : string;
    signal dataflow_in_loop_lteCellSearch_entry25_U0_ap_start : STD_LOGIC;
    signal dataflow_in_loop_lteCellSearch_entry25_U0_ap_done : STD_LOGIC;
    signal dataflow_in_loop_lteCellSearch_entry25_U0_ap_continue : STD_LOGIC;
    signal dataflow_in_loop_lteCellSearch_entry25_U0_ap_idle : STD_LOGIC;
    signal dataflow_in_loop_lteCellSearch_entry25_U0_ap_ready : STD_LOGIC;
    signal dataflow_in_loop_lteCellSearch_entry25_U0_trunc_ln264_out_din : STD_LOGIC_VECTOR (16 downto 0);
    signal dataflow_in_loop_lteCellSearch_entry25_U0_trunc_ln264_out_write : STD_LOGIC;
    signal dataflow_in_loop_lteCellSearch_entry25_U0_trunc_ln264_out1_din : STD_LOGIC_VECTOR (16 downto 0);
    signal dataflow_in_loop_lteCellSearch_entry25_U0_trunc_ln264_out1_write : STD_LOGIC;
    ...
    signal compute_threshold_U0_trunc_ln264_read : STD_LOGIC;
    ...
    signal compute_threshold_U0_trunc_ln264_out_din : STD_LOGIC_VECTOR (16 downto 0);
    signal compute_threshold_U0_trunc_ln264_out_write : STD_LOGIC;
    ...
    signal compute_pss_U0_trunc_ln264_read : STD_LOGIC;
    ...
    signal track_pss_peak_U0_trunc_ln264_read : STD_LOGIC;
    ...
    signal trunc_ln264_c_full_n : STD_LOGIC;
    signal trunc_ln264_c_dout : STD_LOGIC_VECTOR (16 downto 0);
    signal trunc_ln264_c_empty_n : STD_LOGIC;
    signal trunc_ln264_c1_full_n : STD_LOGIC;
    signal trunc_ln264_c1_dout : STD_LOGIC_VECTOR (16 downto 0);
    signal trunc_ln264_c1_empty_n : STD_LOGIC;
    signal trunc_ln264_c2_full_n : STD_LOGIC;
    signal trunc_ln264_c2_dout : STD_LOGIC_VECTOR (16 downto 0);
    signal trunc_ln264_c2_empty_n : STD_LOGIC;
    ...
    signal ap_sync_reg_dataflow_in_loop_lteCellSearch_entry25_U0_ap_ready : STD_LOGIC := '0';
    signal ap_sync_dataflow_in_loop_lteCellSearch_entry25_U0_ap_ready : STD_LOGIC;
    ...
    signal dataflow_in_loop_lteCellSearch_entry25_U0_start_full_n : STD_LOGIC;
    signal dataflow_in_loop_lteCellSearch_entry25_U0_start_write : STD_LOGIC;
    ...
    component lteCellSearch_dataflow_in_loop_lteCellSearch_entry25 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
        ...
        ap_ready : OUT STD_LOGIC;
        trunc_ln264 : IN STD_LOGIC_VECTOR (16 downto 0);
        trunc_ln264_out_din : OUT STD_LOGIC_VECTOR (16 downto 0);
        trunc_ln264_out_full_n : IN STD_LOGIC;
        trunc_ln264_out_write : OUT STD_LOGIC;
        trunc_ln264_out1_din : OUT STD_LOGIC_VECTOR (16 downto 0);
        trunc_ln264_out1_full_n : IN STD_LOGIC;
        trunc_ln264_out1_write : OUT STD_LOGIC );
    end component;
...
begin
    dataflow_in_loop_lteCellSearch_entry25_U0 : component lteCellSearch_dataflow_in_loop_lteCellSearch_entry25
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    trunc_ln264_c_U : component lteCellSearch_fifo_w17_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
    ...
    trunc_ln264_c1_U : component lteCellSearch_fifo_w17_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    trunc_ln264_c2_U : component lteCellSearch_fifo_w17_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ap_sync_reg_dataflow_in_loop_lteCellSearch_entry25_U0_ap_ready_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ap_sync_reg_dataflow_in_loop_lteCellSearch_entry25_U0_ap_ready <= ap_const_logic_0;
            else
                if (((ap_sync_ready and ap_start) = ap_const_logic_1)) then 
                    ap_sync_reg_dataflow_in_loop_lteCellSearch_entry25_U0_ap_ready <= ap_const_logic_0;
                else 
    ...
    ap_done <= track_pss_peak_U0_ap_done;
    ap_idle <= (track_pss_peak_U0_ap_idle and (pss_rslt_2_V_empty_n xor ap_const_logic_1) and (pss_rslt_1_V_empty_n xor ap_const_logic_1) and (pss_rslt_0_V_empty_n xor ap_const_logic_1) and (thresh_V_empty_n xor ap_const_logic_1) and dataflow_in_loop_lteCellSearch_entry25_U0_ap_idle and compute_threshold_U0_ap_idle and compute_pss_U0_ap_idle);
    ...
    ap_sync_dataflow_in_loop_lteCellSearch_entry25_U0_ap_ready <= (dataflow_in_loop_lteCellSearch_entry25_U0_ap_ready or ap_sync_reg_dataflow_in_loop_lteCellSearch_entry25_U0_ap_ready);
    ap_sync_done <= track_pss_peak_U0_ap_done;
    ap_sync_ready <= (ap_sync_dataflow_in_loop_lteCellSearch_entry25_U0_ap_ready and ap_sync_compute_threshold_U0_ap_ready and ap_sync_compute_pss_U0_ap_ready);
    ...
    dataflow_in_loop_lteCellSearch_entry25_U0_ap_continue <= ap_const_logic_1;
    dataflow_in_loop_lteCellSearch_entry25_U0_ap_start <= ((ap_sync_reg_dataflow_in_loop_lteCellSearch_entry25_U0_ap_ready xor ap_const_logic_1) and ap_start);
    dataflow_in_loop_lteCellSearch_entry25_U0_start_full_n <= ap_const_logic_1;
    dataflow_in_loop_lteCellSearch_entry25_U0_start_write <= ap_const_logic_0;
    peak_id_temp <= track_pss_peak_U0_peak_id_temp;
    peak_id_temp_ap_vld <= track_pss_peak_U0_peak_id_temp_ap_vld;
    pss_id_temp <= track_pss_peak_U0_pss_id_temp;
    pss_id_temp_ap_vld <= track_pss_peak_U0_pss_id_temp_ap_vld;

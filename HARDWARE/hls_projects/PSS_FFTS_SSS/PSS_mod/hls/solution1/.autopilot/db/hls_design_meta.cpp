...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("IN_R_TDATA", 16, hls_in, 1, "axis", "in_data", 1),
	Port_Property("IN_R_TVALID", 1, hls_in, 4, "axis", "in_vld", 1),
	Port_Property("IN_R_TREADY", 1, hls_out, 4, "axis", "in_acc", 1),
	Port_Property("IN_R_TKEEP", 2, hls_in, 2, "axis", "in_data", 1),
	Port_Property("IN_R_TSTRB", 2, hls_in, 3, "axis", "in_data", 1),
	Port_Property("IN_R_TLAST", 1, hls_in, 4, "axis", "in_data", 1),
	Port_Property("IN_I_TDATA", 16, hls_in, 5, "axis", "in_data", 1),
	Port_Property("IN_I_TVALID", 1, hls_in, 8, "axis", "in_vld", 1),
	Port_Property("IN_I_TREADY", 1, hls_out, 8, "axis", "in_acc", 1),
	Port_Property("IN_I_TKEEP", 2, hls_in, 6, "axis", "in_data", 1),
	Port_Property("IN_I_TSTRB", 2, hls_in, 7, "axis", "in_data", 1),
	Port_Property("IN_I_TLAST", 1, hls_in, 8, "axis", "in_data", 1),
	Port_Property("OUT_FFT_TDATA", 64, hls_out, 9, "axis", "out_data", 1),
	Port_Property("OUT_FFT_TVALID", 1, hls_out, 12, "axis", "out_vld", 1),
	Port_Property("OUT_FFT_TREADY", 1, hls_in, 12, "axis", "out_acc", 1),
	Port_Property("OUT_FFT_TKEEP", 8, hls_out, 10, "axis", "out_data", 1),
	Port_Property("OUT_FFT_TSTRB", 8, hls_out, 11, "axis", "out_data", 1),
	Port_Property("OUT_FFT_TLAST", 1, hls_out, 12, "axis", "out_data", 1),
	Port_Property("pss_id_TDATA", 32, hls_out, 13, "axis", "out_data", 1),
	Port_Property("pss_id_TVALID", 1, hls_out, 16, "axis", "out_vld", 1),
	Port_Property("pss_id_TREADY", 1, hls_in, 16, "axis", "out_acc", 1),
	Port_Property("pss_id_TKEEP", 4, hls_out, 14, "axis", "out_data", 1),
	Port_Property("pss_id_TSTRB", 4, hls_out, 15, "axis", "out_data", 1),
	Port_Property("pss_id_TLAST", 1, hls_out, 16, "axis", "out_data", 1),
...
const char* HLS_Design_Meta::dut_name = "lteCellSearch";

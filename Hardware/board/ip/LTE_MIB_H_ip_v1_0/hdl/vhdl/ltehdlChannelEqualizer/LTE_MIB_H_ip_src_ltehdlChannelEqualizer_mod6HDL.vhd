-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\zynqRadioHWSWLTEMIBDetectorRFSoC2x2\ltehdlChannelEqualizer\LTE_MIB_H_ip_src_ltehdlChannelEqualizer_mod6HDL.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LTE_MIB_H_ip_src_ltehdlChannelEqualizer_mod6HDL
-- Source Path: ltehdlChannelEqualizer/chEst/mod6HDL
-- Hierarchy Level: 5
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY LTE_MIB_H_ip_src_ltehdlChannelEqualizer_mod6HDL IS
...
END LTE_MIB_H_ip_src_ltehdlChannelEqualizer_mod6HDL;


ARCHITECTURE rtl OF LTE_MIB_H_ip_src_ltehdlChannelEqualizer_mod6HDL IS
...
BEGIN
  ...
  Constant_out1 <= to_signed(16#1555#, 16);
  ...
  Constant1_out1 <= to_unsigned(16#6#, 3);
  ...
  switch_compare_1 <= '1' WHEN Delay10_out1 > to_unsigned(16#005#, 9) ELSE
      '0';

-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\zynqRadioHWSWLTEMIBDetectorRFSoC2x2\LTE_MIB_H_ip_src_subFilter.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LTE_MIB_H_ip_src_subFilter
...
ENTITY LTE_MIB_H_ip_src_subFilter IS
...
END LTE_MIB_H_ip_src_subFilter;


ARCHITECTURE rtl OF LTE_MIB_H_ip_src_subFilter IS

  -- Component Declarations
  COMPONENT LTE_MIB_H_ip_src_FilterTapSystolicWvldin
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
          dinReg2_0_re                    :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En15
          coefIn_0                        :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En16
  ...
  COMPONENT LTE_MIB_H_ip_src_FilterTapSystolicWvldInC0
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
          dinReg2_0_re                    :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En15
          addin                           :   IN    std_logic_vector(47 DOWNTO 0);  -- sfix48_En31
  ...
  FOR ALL : LTE_MIB_H_ip_src_FilterTapSystolicWvldin
    USE ENTITY work.LTE_MIB_H_ip_src_FilterTapSystolicWvldin(rtl);

  FOR ALL : LTE_MIB_H_ip_src_FilterTapSystolicWvldInC0
    USE ENTITY work.LTE_MIB_H_ip_src_FilterTapSystolicWvldInC0(rtl);
  ...
  SIGNAL dout_1_re_tmp                    : signed(32 DOWNTO 0);  -- sfix33_En31

BEGIN
  u_FilterTap_1 : LTE_MIB_H_ip_src_FilterTapSystolicWvldin
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_2 : LTE_MIB_H_ip_src_FilterTapSystolicWvldin
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_3 : LTE_MIB_H_ip_src_FilterTapSystolicWvldin
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_4 : LTE_MIB_H_ip_src_FilterTapSystolicWvldin
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_5 : LTE_MIB_H_ip_src_FilterTapSystolicWvldInC0
    PORT MAP( clk => clk,
              enb => enb,

-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\zynqRadioHWSWLTEMIBDetectorRFSoC2x2\LTE_MIB_H_ip_src_FilterCoef_block2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LTE_MIB_H_ip_src_FilterCoef_block2
...
ENTITY LTE_MIB_H_ip_src_FilterCoef_block2 IS
...
END LTE_MIB_H_ip_src_FilterCoef_block2;


ARCHITECTURE rtl OF LTE_MIB_H_ip_src_FilterCoef_block2 IS
...
BEGIN
  -- CoefReg_1
  CoefData <= to_signed(-16#011C#, 16);

  CoefOut_0 <= std_logic_vector(CoefData);

  -- CoefReg_2
  CoefData_1 <= to_signed(16#06E6#, 16);
  ...
  -- CoefReg_4
  CoefData_3 <= to_signed(16#01D0#, 16);

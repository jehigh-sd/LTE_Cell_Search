-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\zynqRadioHWSWLTEMIBDetectorRFSoC2x2\LTE_MIB_H_ip_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LTE_MIB_H_ip_axi_lite
-- Source Path: LTE_MIB_H_ip/LTE_MIB_H_ip_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY LTE_MIB_H_ip_axi_lite IS
...
END LTE_MIB_H_ip_axi_lite;


ARCHITECTURE rtl OF LTE_MIB_H_ip_axi_lite IS

  -- Component Declarations
  COMPONENT LTE_MIB_H_ip_addr_decoder
  ...
  COMPONENT LTE_MIB_H_ip_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : LTE_MIB_H_ip_addr_decoder
    USE ENTITY work.LTE_MIB_H_ip_addr_decoder(rtl);

  FOR ALL : LTE_MIB_H_ip_axi_lite_module
    USE ENTITY work.LTE_MIB_H_ip_axi_lite_module(rtl);
  ...
  SIGNAL write_extdatasel_in_tmp          : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_start_in_tmp               : std_logic_vector(31 DOWNTO 0);  -- ufix32
...
BEGIN
  u_LTE_MIB_H_ip_addr_decoder_inst : LTE_MIB_H_ip_addr_decoder
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
              ...
              read_ncellid => read_ncellid,  -- sfix32
              read_tddmode => read_tddmode,  -- sfix32
              read_freqest => read_freqest,  -- sfix32
              read_celldetected => read_celldetected,  -- sfix32
              read_cellsearchdone => read_cellsearchdone,  -- sfix32
              read_NDLRB => read_NDLRB,  -- sfix32
              read_PHICH => read_PHICH,  -- sfix32
              read_ng => read_ng,  -- sfix32
              read_nframe => read_nframe,  -- sfix32
              read_cellrefip => read_cellrefip,  -- sfix32
              read_mibdetected => read_mibdetected,  -- sfix32
              read_miberror => read_miberror,  -- sfix32
              data_read => top_data_read,  -- ufix32
              write_axi_enable => write_axi_enable,  -- ufix1
              write_extdatasel_in => write_extdatasel_in_tmp,  -- sfix32
              write_start_in => write_start_in_tmp  -- sfix32
              );

  u_LTE_MIB_H_ip_axi_lite_module_inst : LTE_MIB_H_ip_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
  ...
  write_extdatasel_in <= write_extdatasel_in_tmp;

  write_start_in <= write_start_in_tmp;

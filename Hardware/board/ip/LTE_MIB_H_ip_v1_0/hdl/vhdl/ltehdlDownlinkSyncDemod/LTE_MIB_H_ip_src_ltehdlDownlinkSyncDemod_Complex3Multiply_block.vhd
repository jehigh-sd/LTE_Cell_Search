-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\zynqRadioHWSWLTEMIBDetectorRFSoC2x2\ltehdlDownlinkSyncDemod\LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_Complex3Multiply_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_Complex3Multiply_block
-- Source Path: ltehdlDownlinkSyncDemod/OFDM Demodulation/FFT HDL Optimized/RADIX22FFT_SDF1_5/Complex3Multiply
-- Hierarchy Level: 6
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_Complex3Multiply_block IS
...
END LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_Complex3Multiply_block;


ARCHITECTURE rtl OF LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_Complex3Multiply_block IS
  ...
  SIGNAL adder_add_cast                   : signed(21 DOWNTO 0);  -- sfix22_En15
  SIGNAL adder_add_cast_1                 : signed(21 DOWNTO 0);  -- sfix22_En15
  SIGNAL din_sum                          : signed(21 DOWNTO 0);  -- sfix22_En15
  ...
  SIGNAL Complex3Multiply_din1_re_pipe1   : signed(20 DOWNTO 0) := to_signed(16#000000#, 21);  -- sfix21
  SIGNAL Complex3Multiply_din1_im_pipe1   : signed(20 DOWNTO 0) := to_signed(16#000000#, 21);  -- sfix21
  SIGNAL Complex3Multiply_din1_sum_pipe1  : signed(21 DOWNTO 0) := to_signed(16#000000#, 22);  -- sfix22
  SIGNAL Complex3Multiply_prodOfRe_pipe1  : signed(36 DOWNTO 0) := to_signed(0, 37);  -- sfix37
  SIGNAL Complex3Multiply_ProdOfIm_pipe1  : signed(36 DOWNTO 0) := to_signed(0, 37);  -- sfix37
  SIGNAL Complex3Multiply_prodOfSum_pipe1 : signed(38 DOWNTO 0) := to_signed(0, 39);  -- sfix39
  ...
  SIGNAL prodOfRe                         : signed(36 DOWNTO 0) := to_signed(0, 37);  -- sfix37_En29
  SIGNAL prodOfIm                         : signed(36 DOWNTO 0) := to_signed(0, 37);  -- sfix37_En29
  SIGNAL prodOfSum                        : signed(38 DOWNTO 0) := to_signed(0, 39);  -- sfix39_En29
  ...
  SIGNAL Complex3Add_tmpResult_reg_next   : signed(38 DOWNTO 0);  -- sfix39_En29
  SIGNAL Complex3Add_multRes_re_reg1_next : signed(37 DOWNTO 0);  -- sfix38_En29
  SIGNAL Complex3Add_multRes_re_reg2_next : signed(37 DOWNTO 0);  -- sfix38_En29
  SIGNAL Complex3Add_multRes_im_reg_next  : signed(39 DOWNTO 0);  -- sfix40_En29
  SIGNAL Complex3Add_sub_cast             : signed(37 DOWNTO 0);  -- sfix38_En29
  SIGNAL Complex3Add_sub_cast_1           : signed(37 DOWNTO 0);  -- sfix38_En29
  SIGNAL Complex3Add_sub_cast_2           : signed(39 DOWNTO 0);  -- sfix40_En29
  SIGNAL Complex3Add_sub_cast_3           : signed(39 DOWNTO 0);  -- sfix40_En29
  SIGNAL Complex3Add_add_cast             : signed(37 DOWNTO 0);  -- sfix38_En29
  SIGNAL Complex3Add_add_cast_1           : signed(37 DOWNTO 0);  -- sfix38_En29
  SIGNAL Complex3Add_add_temp             : signed(37 DOWNTO 0);  -- sfix38_En29
  SIGNAL multResFP_re                     : signed(37 DOWNTO 0);  -- sfix38_En29
  SIGNAL multResFP_im                     : signed(39 DOWNTO 0);  -- sfix40_En29
...
BEGIN
  ...
  dinXTwdl_re_tmp <= multResFP_re(34 DOWNTO 14) + ('0' & (multResFP_re(13) AND (( NOT multResFP_re(37)) OR (multResFP_re(12) OR multResFP_re(11) OR multResFP_re(10) OR multResFP_re(9) OR multResFP_re(8) OR multResFP_re(7) OR multResFP_re(6) OR multResFP_re(5) OR multResFP_re(4) OR multResFP_re(3) OR multResFP_re(2) OR multResFP_re(1) OR multResFP_re(0)))));

  dinXTwdl_re <= std_logic_vector(dinXTwdl_re_tmp);

  dinXTwdl_im_tmp <= multResFP_im(34 DOWNTO 14) + ('0' & (multResFP_im(13) AND (( NOT multResFP_im(39)) OR (multResFP_im(12) OR multResFP_im(11) OR multResFP_im(10) OR multResFP_im(9) OR multResFP_im(8) OR multResFP_im(7) OR multResFP_im(6) OR multResFP_im(5) OR multResFP_im(4) OR multResFP_im(3) OR multResFP_im(2) OR multResFP_im(1) OR multResFP_im(0)))));

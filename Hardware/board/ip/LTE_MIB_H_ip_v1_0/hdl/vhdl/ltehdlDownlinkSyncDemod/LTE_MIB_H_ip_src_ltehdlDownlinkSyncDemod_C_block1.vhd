-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\zynqRadioHWSWLTEMIBDetectorRFSoC2x2\ltehdlDownlinkSyncDemod\LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_C_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_C_block1
-- Source Path: ltehdlDownlinkSyncDemod/Sync Signal Search/PSS Searcher/Correlators/PSSXCorr2/C
-- Hierarchy Level: 7
-- 
-- Discrete FIR Filter
-- 
...
ENTITY LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_C_block1 IS
...
END LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_C_block1;


ARCHITECTURE rtl OF LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_C_block1 IS

  -- Component Declarations
  COMPONENT LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FirRdyLogic_block6
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(16 DOWNTO 0);  -- ufix17
  ...
  COMPONENT LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_Addressable_Delay_Line_block9
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(16 DOWNTO 0);  -- ufix17
          ...
          delayLineEnd                    :   OUT   std_logic_vector(16 DOWNTO 0);  -- ufix17
          dataOut                         :   OUT   std_logic_vector(16 DOWNTO 0)  -- ufix17
          );
  END COMPONENT;

  COMPONENT LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FilterTapSystolic_block5
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FirRdyLogic_block6
    USE ENTITY work_ltehdlDownlinkSyncDemod.LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FirRdyLogic_block6(rtl);

  FOR ALL : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_Addressable_Delay_Line_block9
    USE ENTITY work_ltehdlDownlinkSyncDemod.LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_Addressable_Delay_Line_block9(rtl);

  FOR ALL : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FilterTapSystolic_block5
    USE ENTITY work_ltehdlDownlinkSyncDemod.LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FilterTapSystolic_block5(rtl);
  ...
  SIGNAL delayLineEnd0_signed             : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL delayLineDataIn1_1               : signed(16 DOWNTO 0);  -- sfix17_En15
  ...
  SIGNAL delayLineEnd1_signed             : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL delayLineDataIn2_1               : signed(16 DOWNTO 0);  -- sfix17_En15
  ...
  SIGNAL delayLineEnd2_signed             : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL delayLineDataIn3_1               : signed(16 DOWNTO 0);  -- sfix17_En15
  SIGNAL wrAddr3                          : unsigned(4 DOWNTO 0);  -- ufix5
  SIGNAL rdAddrDelayLine3                 : unsigned(4 DOWNTO 0);  -- ufix5
  SIGNAL coeffTableOut3                   : signed(7 DOWNTO 0);  -- sfix8_En9
  SIGNAL delayLineEnd3deadOut             : std_logic_vector(16 DOWNTO 0);  -- ufix17
  SIGNAL delayLineDataOut3                : std_logic_vector(16 DOWNTO 0);  -- ufix17
  SIGNAL coeffTableRegP3_1                : signed(7 DOWNTO 0) := to_signed(16#00#, 8);  -- sfix8_En9
  SIGNAL coeffTableOut2                   : signed(7 DOWNTO 0);  -- sfix8_En9
  SIGNAL coeffTableRegP2_1                : signed(7 DOWNTO 0) := to_signed(16#00#, 8);  -- sfix8_En9
  SIGNAL coeffTableOut1                   : signed(7 DOWNTO 0);  -- sfix8_En9
  SIGNAL coeffTableRegP1_1                : signed(7 DOWNTO 0) := to_signed(16#00#, 8);  -- sfix8_En9
  SIGNAL coeffTableOut0                   : signed(7 DOWNTO 0);  -- sfix8_En9
  SIGNAL coeffTableRegP0_1                : signed(7 DOWNTO 0) := to_signed(16#00#, 8);  -- sfix8_En9
...
BEGIN
  u_firRdyLogic : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FirRdyLogic_block6
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              dataIn => dataIn,  -- ufix17
              validIn => validIn,
              dinSM => dinSM,  -- ufix17
              dinVldSM => dinVldSM
              );

  u_delayLine0 : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_Addressable_Delay_Line_block9
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              dataIn => dinSM,  -- ufix17
              ...
              delayLineEnd => delayLineEnd0,  -- ufix17
              dataOut => delayLineDataOut0  -- ufix17
              );

  u_delayLine1 : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_Addressable_Delay_Line_block9
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              dataIn => std_logic_vector(delayLineDataIn1_1),  -- ufix17
              wrEn => delayLineShiftEn1_1,
              wrAddr => std_logic_vector(wrAddr1),  -- ufix5
              rdAddr => std_logic_vector(rdAddrDelayLine1),  -- ufix5
              delayLineEnd => delayLineEnd1,  -- ufix17
              dataOut => delayLineDataOut1  -- ufix17
              );

  u_delayLine2 : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_Addressable_Delay_Line_block9
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              dataIn => std_logic_vector(delayLineDataIn2_1),  -- ufix17
              wrEn => delayLineShiftEn2_1,
              wrAddr => std_logic_vector(wrAddr2),  -- ufix5
              rdAddr => std_logic_vector(rdAddrDelayLine2),  -- ufix5
              delayLineEnd => delayLineEnd2,  -- ufix17
              dataOut => delayLineDataOut2  -- ufix17
              );

  u_delayLine3 : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_Addressable_Delay_Line_block9
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              dataIn => std_logic_vector(delayLineDataIn3_1),  -- ufix17
              wrEn => delayLineShiftEn3_1,
              wrAddr => std_logic_vector(wrAddr3),  -- ufix5
              rdAddr => std_logic_vector(rdAddrDelayLine3),  -- ufix5
              delayLineEnd => delayLineEnd3deadOut,  -- ufix17
              dataOut => delayLineDataOut3  -- ufix17
              );

  u_filterTap0 : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FilterTapSystolic_block5
    PORT MAP( clk => clk,
              enb => enb,
              din_re => delayLineDataOut0,  -- ufix17
              coeff => std_logic_vector(coeffTableRegP0_1),  -- ufix8
              sumIn => std_logic_vector(sumIn),  -- ufix29
              sumOut => sumOut  -- ufix29
              );

  u_filterTap1 : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FilterTapSystolic_block5
    PORT MAP( clk => clk,
              enb => enb,
              din_re => delayLineDataOut1,  -- ufix17
              coeff => std_logic_vector(coeffTableRegP1_1),  -- ufix8
              sumIn => sumOut,  -- ufix29
              sumOut => sumOut_0  -- ufix29
              );

  u_filterTap2 : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FilterTapSystolic_block5
    PORT MAP( clk => clk,
              enb => enb,
              din_re => delayLineDataOut2,  -- ufix17
              coeff => std_logic_vector(coeffTableRegP2_1),  -- ufix8
              sumIn => sumOut_0,  -- ufix29
              sumOut => sumOut_1  -- ufix29
              );

  u_filterTap3 : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_FilterTapSystolic_block5
    PORT MAP( clk => clk,
              enb => enb,
              din_re => delayLineDataOut3,  -- ufix17
              coeff => std_logic_vector(coeffTableRegP3_1),  -- ufix8
  ...
  BEGIN
    CASE rdAddr3 IS
      WHEN "00000" =>
        coeffTableOut3 <= to_signed(16#00#, 8);
      WHEN "00001" =>
        coeffTableOut3 <= to_signed(-16#04#, 8);
      WHEN "00010" =>
        coeffTableOut3 <= to_signed(16#0D#, 8);
      WHEN "00011" =>
        coeffTableOut3 <= to_signed(16#05#, 8);
      WHEN "00100" =>
        coeffTableOut3 <= to_signed(-16#1D#, 8);
      WHEN "00101" =>
        coeffTableOut3 <= to_signed(-16#2F#, 8);
      WHEN "00110" =>
        coeffTableOut3 <= to_signed(-16#28#, 8);
      WHEN "00111" =>
        coeffTableOut3 <= to_signed(-16#29#, 8);
      WHEN "01000" =>
        coeffTableOut3 <= to_signed(-16#32#, 8);
      WHEN "01001" =>
        coeffTableOut3 <= to_signed(-16#1C#, 8);
      WHEN "01010" =>
        coeffTableOut3 <= to_signed(16#14#, 8);
      WHEN "01011" =>
        coeffTableOut3 <= to_signed(16#22#, 8);
      WHEN "01100" =>
        coeffTableOut3 <= to_signed(-16#07#, 8);
      WHEN "01101" =>
        coeffTableOut3 <= to_signed(-16#2B#, 8);
      WHEN "01110" =>
        coeffTableOut3 <= to_signed(-16#12#, 8);
      WHEN "01111" =>
        coeffTableOut3 <= to_signed(16#25#, 8);
      WHEN "10000" =>
        coeffTableOut3 <= to_signed(16#36#, 8);
      WHEN "10001" =>
        coeffTableOut3 <= to_signed(16#1B#, 8);
      WHEN "10010" =>
        coeffTableOut3 <= to_signed(16#01#, 8);
      WHEN "10011" =>
        coeffTableOut3 <= to_signed(-16#08#, 8);
      WHEN "10100" =>
        coeffTableOut3 <= to_signed(-16#0F#, 8);
      WHEN "10101" =>
        coeffTableOut3 <= to_signed(-16#1A#, 8);
      WHEN "10110" =>
        coeffTableOut3 <= to_signed(-16#11#, 8);
      WHEN "10111" =>
        coeffTableOut3 <= to_signed(16#10#, 8);
      WHEN "11000" =>
        coeffTableOut3 <= to_signed(16#2C#, 8);
      WHEN "11001" =>
        coeffTableOut3 <= to_signed(16#30#, 8);
      WHEN "11010" =>
        coeffTableOut3 <= to_signed(16#2B#, 8);
      WHEN "11011" =>
        coeffTableOut3 <= to_signed(16#30#, 8);
      WHEN "11100" =>
        coeffTableOut3 <= to_signed(16#30#, 8);
      WHEN "11101" =>
        coeffTableOut3 <= to_signed(16#17#, 8);
      WHEN "11110" =>
        coeffTableOut3 <= to_signed(-16#12#, 8);
      WHEN "11111" =>
        coeffTableOut3 <= to_signed(-16#27#, 8);
      WHEN OTHERS => 
        coeffTableOut3 <= to_signed(16#00#, 8);
    END CASE;
  ...
  BEGIN
    CASE rdAddr2 IS
      WHEN "00000" =>
        coeffTableOut2 <= to_signed(16#0C#, 8);
      WHEN "00001" =>
        coeffTableOut2 <= to_signed(-16#15#, 8);
      WHEN "00010" =>
        coeffTableOut2 <= to_signed(-16#26#, 8);
      WHEN "00011" =>
        coeffTableOut2 <= to_signed(-16#0E#, 8);
      WHEN "00100" =>
        coeffTableOut2 <= to_signed(16#18#, 8);
      WHEN "00101" =>
        coeffTableOut2 <= to_signed(16#11#, 8);
      WHEN "00110" =>
        coeffTableOut2 <= to_signed(-16#24#, 8);
      WHEN "00111" =>
        coeffTableOut2 <= to_signed(-16#3B#, 8);
      WHEN "01000" =>
        coeffTableOut2 <= to_signed(-16#0F#, 8);
      WHEN "01001" =>
        coeffTableOut2 <= to_signed(16#1B#, 8);
      WHEN "01010" =>
        coeffTableOut2 <= to_signed(-16#04#, 8);
      WHEN "01011" =>
        coeffTableOut2 <= to_signed(-16#3E#, 8);
      WHEN "01100" =>
        coeffTableOut2 <= to_signed(-16#35#, 8);
      WHEN "01101" =>
        coeffTableOut2 <= to_signed(16#10#, 8);
      WHEN "01110" =>
        coeffTableOut2 <= to_signed(16#33#, 8);
      WHEN "01111" =>
        coeffTableOut2 <= to_signed(16#13#, 8);
      WHEN "10000" =>
        coeffTableOut2 <= to_signed(-16#14#, 8);
      WHEN "10001" =>
        coeffTableOut2 <= to_signed(-16#1D#, 8);
      WHEN "10010" =>
        coeffTableOut2 <= to_signed(-16#25#, 8);
      WHEN "10011" =>
        coeffTableOut2 <= to_signed(-16#3B#, 8);
      WHEN "10100" =>
        coeffTableOut2 <= to_signed(-16#34#, 8);
      WHEN "10101" =>
        coeffTableOut2 <= to_signed(-16#05#, 8);
      WHEN "10110" =>
        coeffTableOut2 <= to_signed(16#1C#, 8);
      WHEN "10111" =>
        coeffTableOut2 <= to_signed(16#09#, 8);
      WHEN "11000" =>
        coeffTableOut2 <= to_signed(-16#11#, 8);
      WHEN "11001" =>
        coeffTableOut2 <= to_signed(16#02#, 8);
      WHEN "11010" =>
        coeffTableOut2 <= to_signed(16#28#, 8);
      WHEN "11011" =>
        coeffTableOut2 <= to_signed(16#30#, 8);
      WHEN "11100" =>
        coeffTableOut2 <= to_signed(16#25#, 8);
      WHEN "11101" =>
        coeffTableOut2 <= to_signed(16#2B#, 8);
      WHEN "11110" =>
        coeffTableOut2 <= to_signed(16#35#, 8);
      WHEN "11111" =>
        coeffTableOut2 <= to_signed(16#21#, 8);
      WHEN OTHERS => 
        coeffTableOut2 <= to_signed(16#00#, 8);
    END CASE;
  ...
  BEGIN
    CASE rdAddr1 IS
      WHEN "00000" =>
        coeffTableOut1 <= to_signed(16#35#, 8);
      WHEN "00001" =>
        coeffTableOut1 <= to_signed(16#2B#, 8);
      WHEN "00010" =>
        coeffTableOut1 <= to_signed(16#25#, 8);
      WHEN "00011" =>
        coeffTableOut1 <= to_signed(16#30#, 8);
      WHEN "00100" =>
        coeffTableOut1 <= to_signed(16#28#, 8);
      WHEN "00101" =>
        coeffTableOut1 <= to_signed(16#02#, 8);
      WHEN "00110" =>
        coeffTableOut1 <= to_signed(-16#11#, 8);
      WHEN "00111" =>
        coeffTableOut1 <= to_signed(16#09#, 8);
      WHEN "01000" =>
        coeffTableOut1 <= to_signed(16#1C#, 8);
      WHEN "01001" =>
        coeffTableOut1 <= to_signed(-16#05#, 8);
      WHEN "01010" =>
        coeffTableOut1 <= to_signed(-16#34#, 8);
      WHEN "01011" =>
        coeffTableOut1 <= to_signed(-16#3B#, 8);
      WHEN "01100" =>
        coeffTableOut1 <= to_signed(-16#25#, 8);
      WHEN "01101" =>
        coeffTableOut1 <= to_signed(-16#1D#, 8);
      WHEN "01110" =>
        coeffTableOut1 <= to_signed(-16#14#, 8);
      WHEN "01111" =>
        coeffTableOut1 <= to_signed(16#13#, 8);
      WHEN "10000" =>
        coeffTableOut1 <= to_signed(16#33#, 8);
      WHEN "10001" =>
        coeffTableOut1 <= to_signed(16#10#, 8);
      WHEN "10010" =>
        coeffTableOut1 <= to_signed(-16#35#, 8);
      WHEN "10011" =>
        coeffTableOut1 <= to_signed(-16#3E#, 8);
      WHEN "10100" =>
        coeffTableOut1 <= to_signed(-16#04#, 8);
      WHEN "10101" =>
        coeffTableOut1 <= to_signed(16#1B#, 8);
      WHEN "10110" =>
        coeffTableOut1 <= to_signed(-16#0F#, 8);
      WHEN "10111" =>
        coeffTableOut1 <= to_signed(-16#3B#, 8);
      WHEN "11000" =>
        coeffTableOut1 <= to_signed(-16#24#, 8);
      WHEN "11001" =>
        coeffTableOut1 <= to_signed(16#11#, 8);
      WHEN "11010" =>
        coeffTableOut1 <= to_signed(16#18#, 8);
      WHEN "11011" =>
        coeffTableOut1 <= to_signed(-16#0E#, 8);
      WHEN "11100" =>
        coeffTableOut1 <= to_signed(-16#26#, 8);
      WHEN "11101" =>
        coeffTableOut1 <= to_signed(-16#15#, 8);
      WHEN "11110" =>
        coeffTableOut1 <= to_signed(16#0C#, 8);
      WHEN "11111" =>
        coeffTableOut1 <= to_signed(16#1A#, 8);
      WHEN OTHERS => 
        coeffTableOut1 <= to_signed(16#00#, 8);
    END CASE;
  ...
  BEGIN
    CASE rdAddr0_1 IS
      WHEN "00000" =>
        coeffTableOut0 <= to_signed(-16#12#, 8);
      WHEN "00001" =>
        coeffTableOut0 <= to_signed(16#17#, 8);
      WHEN "00010" =>
        coeffTableOut0 <= to_signed(16#30#, 8);
      WHEN "00011" =>
        coeffTableOut0 <= to_signed(16#30#, 8);
      WHEN "00100" =>
        coeffTableOut0 <= to_signed(16#2B#, 8);
      WHEN "00101" =>
        coeffTableOut0 <= to_signed(16#30#, 8);
      WHEN "00110" =>
        coeffTableOut0 <= to_signed(16#2C#, 8);
      WHEN "00111" =>
        coeffTableOut0 <= to_signed(16#10#, 8);
      WHEN "01000" =>
        coeffTableOut0 <= to_signed(-16#11#, 8);
      WHEN "01001" =>
        coeffTableOut0 <= to_signed(-16#1A#, 8);
      WHEN "01010" =>
        coeffTableOut0 <= to_signed(-16#0F#, 8);
      WHEN "01011" =>
        coeffTableOut0 <= to_signed(-16#08#, 8);
      WHEN "01100" =>
        coeffTableOut0 <= to_signed(16#01#, 8);
      WHEN "01101" =>
        coeffTableOut0 <= to_signed(16#1B#, 8);
      WHEN "01110" =>
        coeffTableOut0 <= to_signed(16#36#, 8);
      WHEN "01111" =>
        coeffTableOut0 <= to_signed(16#25#, 8);
      WHEN "10000" =>
        coeffTableOut0 <= to_signed(-16#12#, 8);
      WHEN "10001" =>
        coeffTableOut0 <= to_signed(-16#2B#, 8);
      WHEN "10010" =>
        coeffTableOut0 <= to_signed(-16#07#, 8);
      WHEN "10011" =>
        coeffTableOut0 <= to_signed(16#22#, 8);
      WHEN "10100" =>
        coeffTableOut0 <= to_signed(16#14#, 8);
      WHEN "10101" =>
        coeffTableOut0 <= to_signed(-16#1C#, 8);
      WHEN "10110" =>
        coeffTableOut0 <= to_signed(-16#32#, 8);
      WHEN "10111" =>
        coeffTableOut0 <= to_signed(-16#29#, 8);
      WHEN "11000" =>
        coeffTableOut0 <= to_signed(-16#28#, 8);
      WHEN "11001" =>
        coeffTableOut0 <= to_signed(-16#2F#, 8);
      WHEN "11010" =>
        coeffTableOut0 <= to_signed(-16#1D#, 8);
      WHEN "11011" =>
        coeffTableOut0 <= to_signed(16#05#, 8);
      WHEN "11100" =>
        coeffTableOut0 <= to_signed(16#0D#, 8);
      WHEN "11101" =>
        coeffTableOut0 <= to_signed(-16#04#, 8);
      WHEN "11110" =>
        coeffTableOut0 <= to_signed(16#00#, 8);
      WHEN "11111" =>
        coeffTableOut0 <= to_signed(16#21#, 8);
      WHEN OTHERS => 
        coeffTableOut0 <= to_signed(16#00#, 8);
    END CASE;

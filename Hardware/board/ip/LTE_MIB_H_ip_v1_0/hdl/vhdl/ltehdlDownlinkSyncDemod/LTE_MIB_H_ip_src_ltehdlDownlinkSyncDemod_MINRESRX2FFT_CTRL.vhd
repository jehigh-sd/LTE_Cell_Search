-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\zynqRadioHWSWLTEMIBDetectorRFSoC2x2\ltehdlDownlinkSyncDemod\LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_MINRESRX2FFT_CTRL.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_MINRESRX2FFT_CTRL
-- Source Path: ltehdlDownlinkSyncDemod/Sync Signal Search/SSS Searcher/FFT HDL Optimized/MINRESRX2FFT_CTRL
-- Hierarchy Level: 6
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_MINRESRX2FFT_CTRL IS
...
END LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_MINRESRX2FFT_CTRL;


ARCHITECTURE rtl OF LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_MINRESRX2FFT_CTRL IS

  -- Signals
  SIGNAL din_1_re_signed                  : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL din_1_im_signed                  : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL stgOut1_re_signed                : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL stgOut1_im_signed                : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL stgOut2_re_signed                : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL stgOut2_im_signed                : signed(15 DOWNTO 0);  -- sfix16_En15
  ...
  SIGNAL minResRX2FFTCtrl_dOut1Re_Reg     : signed(15 DOWNTO 0);  -- sfix16
  SIGNAL minResRX2FFTCtrl_dOut2Re_Reg     : signed(15 DOWNTO 0);  -- sfix16
  SIGNAL minResRX2FFTCtrl_dOut1Im_Reg     : signed(15 DOWNTO 0);  -- sfix16
  SIGNAL minResRX2FFTCtrl_dOut2Im_Reg     : signed(15 DOWNTO 0);  -- sfix16
  SIGNAL minResRX2FFTCtrl_xSample_re      : signed(15 DOWNTO 0);  -- sfix16
  SIGNAL minResRX2FFTCtrl_xSample_im      : signed(15 DOWNTO 0);  -- sfix16
  ...
  SIGNAL minResRX2FFTCtrl_dOut1Re_Reg_next : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL minResRX2FFTCtrl_dOut2Re_Reg_next : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL minResRX2FFTCtrl_dOut1Im_Reg_next : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL minResRX2FFTCtrl_dOut2Im_Reg_next : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL minResRX2FFTCtrl_xSample_re_next : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL minResRX2FFTCtrl_xSample_im_next : signed(15 DOWNTO 0);  -- sfix16_En15
  ...
  SIGNAL dMemIn1_re_tmp                   : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL dMemIn1_im_tmp                   : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL dMemIn2_re_tmp                   : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL dMemIn2_im_tmp                   : signed(15 DOWNTO 0);  -- sfix16_En15
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        ...
        minResRX2FFTCtrl_dOut1Re_Reg <= to_signed(16#0000#, 16);
        minResRX2FFTCtrl_dOut2Re_Reg <= to_signed(16#0000#, 16);
        minResRX2FFTCtrl_dOut1Im_Reg <= to_signed(16#0000#, 16);
        minResRX2FFTCtrl_dOut2Im_Reg <= to_signed(16#0000#, 16);
        minResRX2FFTCtrl_rdEnb1_Reg <= '0';
        minResRX2FFTCtrl_rdEnb2_Reg <= '0';
        minResRX2FFTCtrl_rdEnb3_Reg <= '0';
        minResRX2FFTCtrl_xSample_re <= to_signed(16#0000#, 16);
        minResRX2FFTCtrl_xSample_im <= to_signed(16#0000#, 16);
  ...
  BEGIN
    ...
    CASE minResRX2FFTCtrl_state IS
      WHEN "0000" =>
        ...
        minResRX2FFTCtrl_dOut1Re_Reg_next <= to_signed(16#0000#, 16);
        minResRX2FFTCtrl_dOut2Re_Reg_next <= to_signed(16#0000#, 16);
        minResRX2FFTCtrl_dOut1Im_Reg_next <= to_signed(16#0000#, 16);
        minResRX2FFTCtrl_dOut2Im_Reg_next <= to_signed(16#0000#, 16);
        minResRX2FFTCtrl_xSample_re_next <= to_signed(16#0000#, 16);
        minResRX2FFTCtrl_xSample_im_next <= to_signed(16#0000#, 16);

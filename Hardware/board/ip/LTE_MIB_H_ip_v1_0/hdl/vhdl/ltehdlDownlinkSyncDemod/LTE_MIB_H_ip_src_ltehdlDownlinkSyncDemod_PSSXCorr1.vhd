-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\zynqRadioHWSWLTEMIBDetectorRFSoC2x2\ltehdlDownlinkSyncDemod\LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_PSSXCorr1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_PSSXCorr1
-- Source Path: ltehdlDownlinkSyncDemod/Sync Signal Search/PSS Searcher/Correlators/PSSXCorr1
-- Hierarchy Level: 6
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_PSSXCorr1 IS
...
END LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_PSSXCorr1;


ARCHITECTURE rtl OF LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_PSSXCorr1 IS

  -- Component Declarations
  COMPONENT LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_C_D_block2
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_C_block
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_C_D_block1
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          dataIn                          :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
  ...
  FOR ALL : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_C_D_block2
    USE ENTITY work_ltehdlDownlinkSyncDemod.LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_C_D_block2(rtl);

  FOR ALL : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_C_block
    USE ENTITY work_ltehdlDownlinkSyncDemod.LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_C_block(rtl);

  FOR ALL : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_C_D_block1
    USE ENTITY work_ltehdlDownlinkSyncDemod.LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_C_D_block1(rtl);
...
BEGIN
  ...
  u_C_D : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_C_D_block2
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_C : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_C_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_C_D_1 : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_C_D_block1
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,

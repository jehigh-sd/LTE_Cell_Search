-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\zynqRadioHWSWLTEMIBDetectorRFSoC2x2\ltehdlDownlinkSyncDemod\LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_WaveformGen_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_WaveformGen_block
-- Source Path: ltehdlDownlinkSyncDemod/Frequency Correction 1x/NCO HDL Optimized1/WaveformGen
-- Hierarchy Level: 5
-- 
...
ENTITY LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_WaveformGen_block IS
...
END LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_WaveformGen_block;


ARCHITECTURE rtl OF LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_WaveformGen_block IS

  -- Component Declarations
  COMPONENT LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_CosLookUpTableGen_block
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_SinLookUpTableGen_block
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
          lutaddr                         :   IN    std_logic_vector(10 DOWNTO 0);  -- ufix11
  ...
  FOR ALL : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_CosLookUpTableGen_block
    USE ENTITY work_ltehdlDownlinkSyncDemod.LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_CosLookUpTableGen_block(rtl);

  FOR ALL : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_SinLookUpTableGen_block
    USE ENTITY work_ltehdlDownlinkSyncDemod.LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_SinLookUpTableGen_block(rtl);
...
BEGIN
  u_Cos_Wave_inst : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_CosLookUpTableGen_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_Sin_Wave_inst : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_SinLookUpTableGen_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              lutaddr => std_logic_vector(lutaddrO),  -- ufix11

-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\zynqRadioHWSWLTEMIBDetectorRFSoC2x2\ltehdlDownlinkSyncDemod\LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_MINRESRX2FFT_MEMORY.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_MINRESRX2FFT_MEMORY
-- Source Path: ltehdlDownlinkSyncDemod/Sync Signal Search/SSS Searcher/FFT HDL Optimized/MINRESRX2FFT_MEMORY
-- Hierarchy Level: 6
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_MINRESRX2FFT_MEMORY IS
...
END LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_MINRESRX2FFT_MEMORY;


ARCHITECTURE rtl OF LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_MINRESRX2FFT_MEMORY IS
  ...
  -- Signals
  SIGNAL dMemIn1_re_signed                : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL intdelay_reg                     : vector_of_signed16(0 TO 1);  -- sfix16 [2]
  SIGNAL wrData01Dly_re                   : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL stage_unsigned                   : unsigned(2 DOWNTO 0);  -- ufix3
  SIGNAL dMemIn2_re_signed                : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL intdelay_reg_1                   : vector_of_signed16(0 TO 1);  -- sfix16 [2]
  SIGNAL wrData10Dly_re                   : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL dMemIn2_im_signed                : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL intdelay_reg_2                   : vector_of_signed16(0 TO 1);  -- sfix16 [2]
  SIGNAL wrData10Dly_im                   : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL intdelay_reg_3                   : vector_of_signed16(0 TO 1);  -- sfix16 [2]
  SIGNAL wrData11Dly_re                   : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL intdelay_reg_4                   : vector_of_signed16(0 TO 1);  -- sfix16 [2]
  SIGNAL wrData11Dly_im                   : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL rdAddr10                         : unsigned(5 DOWNTO 0);  -- ufix6
  SIGNAL wrAddr10                         : unsigned(5 DOWNTO 0);  -- ufix6
  SIGNAL wrEnb11                          : std_logic;
  SIGNAL rdData11_im                      : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL rdData11_im_signed               : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL rdData11_re                      : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL rdData11_re_signed               : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL wrEnb10                          : std_logic;
  SIGNAL rdData10_im                      : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL rdData10_im_signed               : signed(15 DOWNTO 0);  -- sfix16_En15
  ...
  SIGNAL rdData10_re                      : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL rdData10_re_signed               : signed(15 DOWNTO 0);  -- sfix16_En15
  ...
  SIGNAL dMemOut2_re_tmp                  : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL dMemOut2_im_tmp                  : signed(15 DOWNTO 0);  -- sfix16_En15
  ...
  SIGNAL dMemOut1_re_tmp                  : std_logic_vector(15 DOWNTO 0);  -- ufix16
  SIGNAL dMemIn1_im_signed                : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL intdelay_reg_5                   : vector_of_signed16(0 TO 1);  -- sfix16 [2]
  SIGNAL wrData01Dly_im                   : signed(15 DOWNTO 0);  -- sfix16_En15
  SIGNAL dMemOut1_im_tmp                  : std_logic_vector(15 DOWNTO 0);  -- ufix16

BEGIN
  u_dataMEM_im_11 : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_SimpleDualPortRAM_generic
  ...
  u_dataMEM_re_11 : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 6,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_dataMEM_im_10 : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 6,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_dataMEM_re_10 : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 6,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_dataMEM_re_01 : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 6,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  u_dataMEM_im_01 : LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_SimpleDualPortRAM_generic
    GENERIC MAP( AddrWidth => 6,
                 DataWidth => 16
                 )
    PORT MAP( clk => clk,
  ...
  BEGIN
    ...
    ELSE 
      dMemOut2_re_tmp <= to_signed(16#0000#, 16);
      dMemOut2_im_tmp <= to_signed(16#0000#, 16);
    END IF;

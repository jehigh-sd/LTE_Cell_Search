-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\zynqRadioHWSWLTEMIBDetectorRFSoC2x2\ltehdlDownlinkSyncDemod\LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_Decimator.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_Decimator
-- Source Path: ltehdlDownlinkSyncDemod/Decimation Filters/CIC Compensation Decimator/Decimator
-- Hierarchy Level: 5
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_Decimator IS
...
END LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_Decimator;


ARCHITECTURE rtl OF LTE_MIB_H_ip_src_ltehdlDownlinkSyncDemod_Decimator IS
  ...
  SIGNAL count_next                       : std_logic;  -- ufix1
...
BEGIN
  ...
  Decimator_output : PROCESS (count, dataOutReg_im, dataOutReg_re, in0_im_signed, in0_re_signed, validIn,
       validOutReg)
  ...
  BEGIN
    ...
    IF (validIn AND ( NOT count)) = '1' THEN 

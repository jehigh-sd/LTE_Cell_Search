-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\zynqRadioHWSWLTEMIBDetectorRFSoC2x2\LTE_MIB_H_ip_fifo_data_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LTE_MIB_H_ip_fifo_data_block
-- Source Path: LTE_MIB_H_ip/LTE_MIB_H_ip_axi4_stream_q_slave/LTE_MIB_H_ip_fifo_data
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY LTE_MIB_H_ip_fifo_data_block IS
...
END LTE_MIB_H_ip_fifo_data_block;


ARCHITECTURE rtl OF LTE_MIB_H_ip_fifo_data_block IS

  -- Component Declarations
  COMPONENT LTE_MIB_H_ip_SimpleDualPortRAM_generic
  ...
  FOR ALL : LTE_MIB_H_ip_SimpleDualPortRAM_generic
    USE ENTITY work.LTE_MIB_H_ip_SimpleDualPortRAM_generic(rtl);
...
BEGIN
  ...
  u_LTE_MIB_H_ip_fifo_data_classic_ram : LTE_MIB_H_ip_SimpleDualPortRAM_generic

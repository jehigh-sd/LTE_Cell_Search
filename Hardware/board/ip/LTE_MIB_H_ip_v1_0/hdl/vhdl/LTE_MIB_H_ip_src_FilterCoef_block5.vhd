-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\zynqRadioHWSWLTEMIBDetectorRFSoC2x2\LTE_MIB_H_ip_src_FilterCoef_block5.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LTE_MIB_H_ip_src_FilterCoef_block5
...
ENTITY LTE_MIB_H_ip_src_FilterCoef_block5 IS
...
END LTE_MIB_H_ip_src_FilterCoef_block5;


ARCHITECTURE rtl OF LTE_MIB_H_ip_src_FilterCoef_block5 IS
...
BEGIN
  -- CoefReg_1
  CoefData <= to_signed(16#0069#, 16);

  CoefOut_0 <= std_logic_vector(CoefData);

  -- CoefReg_2
  CoefData_1 <= to_signed(-16#051A#, 16);

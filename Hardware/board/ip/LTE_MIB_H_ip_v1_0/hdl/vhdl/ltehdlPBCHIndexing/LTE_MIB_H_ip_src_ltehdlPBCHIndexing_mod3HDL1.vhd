-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\zynqRadioHWSWLTEMIBDetectorRFSoC2x2\ltehdlPBCHIndexing\LTE_MIB_H_ip_src_ltehdlPBCHIndexing_mod3HDL1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LTE_MIB_H_ip_src_ltehdlPBCHIndexing_mod3HDL1
-- Source Path: ltehdlPBCHIndexing/PBCHIndGen/mod3HDL1
-- Hierarchy Level: 5
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY LTE_MIB_H_ip_src_ltehdlPBCHIndexing_mod3HDL1 IS
...
END LTE_MIB_H_ip_src_ltehdlPBCHIndexing_mod3HDL1;


ARCHITECTURE rtl OF LTE_MIB_H_ip_src_ltehdlPBCHIndexing_mod3HDL1 IS

  -- Signals
  SIGNAL addr_in_unsigned                 : unsigned(8 DOWNTO 0);  -- ufix9
...
BEGIN
  ...
  Product1_cast <= signed(resize(addr_in_unsigned, 10));
  ...
  Constant1_out1 <= to_unsigned(16#003#, 9);

-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\zynqRadioHWSWLTEMIBDetectorRFSoC2x2\LTE_MIB_H_ip_src_subFilter_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LTE_MIB_H_ip_src_subFilter_block1
...
ENTITY LTE_MIB_H_ip_src_subFilter_block1 IS
...
END LTE_MIB_H_ip_src_subFilter_block1;


ARCHITECTURE rtl OF LTE_MIB_H_ip_src_subFilter_block1 IS

  -- Component Declarations
  COMPONENT LTE_MIB_H_ip_src_FilterTapSystolicWvldin_block1
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
          dinReg2_2_re                    :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En15
          coefIn_0                        :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En16
  ...
  COMPONENT LTE_MIB_H_ip_src_FilterTapSystolicWvldInC0_block1
    PORT( clk                             :   IN    std_logic;
          enb                             :   IN    std_logic;
          dinReg2_2_re                    :   IN    std_logic_vector(15 DOWNTO 0);  -- sfix16_En15
          addin                           :   IN    std_logic_vector(47 DOWNTO 0);  -- sfix48_En31
  ...
  FOR ALL : LTE_MIB_H_ip_src_FilterTapSystolicWvldin_block1
    USE ENTITY work.LTE_MIB_H_ip_src_FilterTapSystolicWvldin_block1(rtl);

  FOR ALL : LTE_MIB_H_ip_src_FilterTapSystolicWvldInC0_block1
    USE ENTITY work.LTE_MIB_H_ip_src_FilterTapSystolicWvldInC0_block1(rtl);
  ...
  SIGNAL dout_3_re_tmp                    : signed(32 DOWNTO 0);  -- sfix33_En31

BEGIN
  u_FilterTap_1 : LTE_MIB_H_ip_src_FilterTapSystolicWvldin_block1
    PORT MAP( clk => clk,
              enb => enb,
  ...
  u_FilterTap_2 : LTE_MIB_H_ip_src_FilterTapSystolicWvldin_block1
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_2_re => dinDly2,  -- sfix16_En15
  ...
  u_FilterTap_3 : LTE_MIB_H_ip_src_FilterTapSystolicWvldin_block1
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_2_re => dinDly2_1,  -- sfix16_En15
  ...
  u_FilterTap_4 : LTE_MIB_H_ip_src_FilterTapSystolicWvldin_block1
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_2_re => dinDly2_2,  -- sfix16_En15
  ...
  u_FilterTap_5 : LTE_MIB_H_ip_src_FilterTapSystolicWvldInC0_block1
    PORT MAP( clk => clk,
              enb => enb,
              dinReg2_2_re => dinDly2_3,  -- sfix16_En15

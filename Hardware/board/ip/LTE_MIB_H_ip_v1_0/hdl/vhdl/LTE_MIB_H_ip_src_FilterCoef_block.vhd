-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\zynqRadioHWSWLTEMIBDetectorRFSoC2x2\LTE_MIB_H_ip_src_FilterCoef_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LTE_MIB_H_ip_src_FilterCoef_block
...
ENTITY LTE_MIB_H_ip_src_FilterCoef_block IS
...
END LTE_MIB_H_ip_src_FilterCoef_block;


ARCHITECTURE rtl OF LTE_MIB_H_ip_src_FilterCoef_block IS
...
BEGIN
  -- CoefReg_1
  CoefData <= to_signed(16#022B#, 16);

  CoefOut_0 <= std_logic_vector(CoefData);

  -- CoefReg_2
  CoefData_1 <= to_signed(-16#142A#, 16);

  CoefOut_1 <= std_logic_vector(CoefData_1);

  -- CoefReg_3
  CoefData_2 <= to_signed(-16#091E#, 16);

-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\zynqRadioHWSWLTEMIBDetectorRFSoC2x2\LTE_MIB_H_ip_src_FilterTapSystolicWvldInC0_block1.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LTE_MIB_H_ip_src_FilterTapSystolicWvldInC0_block1
...
ENTITY LTE_MIB_H_ip_src_FilterTapSystolicWvldInC0_block1 IS
...
END LTE_MIB_H_ip_src_FilterTapSystolicWvldInC0_block1;


ARCHITECTURE rtl OF LTE_MIB_H_ip_src_FilterTapSystolicWvldInC0_block1 IS
...
BEGIN
  ...
  fTap_output : PROCESS (addin_signed, dinReg2_2_re_signed, dinRegVld, fTap_addout_reg, fTap_din1_reg1,
       fTap_din1_reg2)
  BEGIN
    ...
    IF dinRegVld = '1' THEN 
      ...
      fTap_din1_reg1_next <= dinReg2_2_re_signed;
    END IF;

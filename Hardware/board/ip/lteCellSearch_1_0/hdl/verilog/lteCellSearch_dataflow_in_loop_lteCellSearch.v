...
wire    dataflow_in_loop_lteCellSearch_entry21_U0_ap_start;
wire    dataflow_in_loop_lteCellSearch_entry21_U0_ap_done;
wire    dataflow_in_loop_lteCellSearch_entry21_U0_ap_continue;
wire    dataflow_in_loop_lteCellSearch_entry21_U0_ap_idle;
wire    dataflow_in_loop_lteCellSearch_entry21_U0_ap_ready;
wire   [16:0] dataflow_in_loop_lteCellSearch_entry21_U0_trunc_ln236_out_din;
wire    dataflow_in_loop_lteCellSearch_entry21_U0_trunc_ln236_out_write;
wire   [16:0] dataflow_in_loop_lteCellSearch_entry21_U0_trunc_ln236_out1_din;
wire    dataflow_in_loop_lteCellSearch_entry21_U0_trunc_ln236_out1_write;
...
wire    compute_threshold_U0_trunc_ln236_read;
wire   [16:0] compute_threshold_U0_IN_imag_V_address0;
wire    compute_threshold_U0_IN_imag_V_ce0;
wire   [16:0] compute_threshold_U0_trunc_ln236_out_din;
wire    compute_threshold_U0_trunc_ln236_out_write;
...
wire    compute_pss_U0_trunc_ln236_read;
...
wire    track_pss_peak_U0_trunc_ln236_read;
...
wire    trunc_ln236_c_full_n;
wire   [16:0] trunc_ln236_c_dout;
wire    trunc_ln236_c_empty_n;
wire    trunc_ln236_c1_full_n;
wire   [16:0] trunc_ln236_c1_dout;
wire    trunc_ln236_c1_empty_n;
wire    trunc_ln236_c2_full_n;
wire   [16:0] trunc_ln236_c2_dout;
wire    trunc_ln236_c2_empty_n;
...
wire    ap_sync_done;
wire    ap_sync_ready;
reg    ap_sync_reg_dataflow_in_loop_lteCellSearch_entry21_U0_ap_ready;
wire    ap_sync_dataflow_in_loop_lteCellSearch_entry21_U0_ap_ready;
...
wire    dataflow_in_loop_lteCellSearch_entry21_U0_start_full_n;
wire    dataflow_in_loop_lteCellSearch_entry21_U0_start_write;
...
#0 ap_sync_reg_dataflow_in_loop_lteCellSearch_entry21_U0_ap_ready = 1'b0;
#0 ap_sync_reg_compute_threshold_U0_ap_ready = 1'b0;
#0 ap_sync_reg_compute_pss_U0_ap_ready = 1'b0;
end

lteCellSearch_dataflow_in_loop_lteCellSearch_entry21 dataflow_in_loop_lteCellSearch_entry21_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
lteCellSearch_fifo_w17_d2_S trunc_ln236_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
lteCellSearch_fifo_w17_d2_S trunc_ln236_c1_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
lteCellSearch_fifo_w17_d2_S trunc_ln236_c2_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ap_sync_reg_dataflow_in_loop_lteCellSearch_entry21_U0_ap_ready <= 1'b0;
    end else begin
        if (((ap_sync_ready & ap_start) == 1'b1)) begin
            ap_sync_reg_dataflow_in_loop_lteCellSearch_entry21_U0_ap_ready <= 1'b0;
        end else begin
...
assign ap_idle = (track_pss_peak_U0_ap_idle & (pss_rslt_2_V_empty_n ^ 1'b1) & (pss_rslt_1_V_empty_n ^ 1'b1) & (pss_rslt_0_V_empty_n ^ 1'b1) & (thresh_V_empty_n ^ 1'b1) & dataflow_in_loop_lteCellSearch_entry21_U0_ap_idle & compute_threshold_U0_ap_idle & compute_pss_U0_ap_idle);
...
assign ap_sync_dataflow_in_loop_lteCellSearch_entry21_U0_ap_ready = (dataflow_in_loop_lteCellSearch_entry21_U0_ap_ready | ap_sync_reg_dataflow_in_loop_lteCellSearch_entry21_U0_ap_ready);

assign ap_sync_done = track_pss_peak_U0_ap_done;

assign ap_sync_ready = (ap_sync_dataflow_in_loop_lteCellSearch_entry21_U0_ap_ready & ap_sync_compute_threshold_U0_ap_ready & ap_sync_compute_pss_U0_ap_ready);
...
assign dataflow_in_loop_lteCellSearch_entry21_U0_ap_continue = 1'b1;

assign dataflow_in_loop_lteCellSearch_entry21_U0_ap_start = ((ap_sync_reg_dataflow_in_loop_lteCellSearch_entry21_U0_ap_ready ^ 1'b1) & ap_start);

assign dataflow_in_loop_lteCellSearch_entry21_U0_start_full_n = 1'b1;

assign dataflow_in_loop_lteCellSearch_entry21_U0_start_write = 1'b0;

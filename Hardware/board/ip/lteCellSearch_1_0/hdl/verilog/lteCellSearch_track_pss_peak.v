...
reg   [16:0] trunc_ln236_read_reg_445;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((~((ap_start == 1'b0) | (trunc_ln236_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (or_ln183_1_fu_304_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (posedge ap_clk) begin
    if ((~((ap_start == 1'b0) | (trunc_ln236_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (or_ln183_fu_268_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) | (~((ap_start == 1'b0) | (trunc_ln236_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1)))) begin
...
always @ (*) begin
    if ((~((ap_start == 1'b0) | (trunc_ln236_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    ap_block_state1 = ((ap_start == 1'b0) | (trunc_ln236_empty_n == 1'b0) | (ap_done_reg == 1'b1));
end
...
assign run_fu_146_p2 = ((trunc_ln236_dout != 17'd0) ? 1'b1 : 1'b0);
...
assign zext_ln190_1_fu_359_p1 = trunc_ln236_dout;

assign zext_ln190_fu_431_p1 = trunc_ln236_read_reg_445;

assign zext_ln191_fu_369_p1 = add_ln191_fu_363_p2;

assign zext_ln192_fu_440_p1 = add_ln192_fu_434_p2;

assign zext_ln534_fu_354_p1 = trunc_ln236_dout;

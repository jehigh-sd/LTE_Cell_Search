-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\zynqRadioHWSWLTEPBCHGeneratorRFSoC2x2\LTE_GENER_ip_src_Filter_block3.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LTE_GENER_ip_src_Filter_block3
...
-- FIR Filter HDL Optimized4/Filte
-- Hierarchy Level: 5
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY LTE_GENER_ip_src_Filter_block3 IS
...
END LTE_GENER_ip_src_Filter_block3;


ARCHITECTURE rtl OF LTE_GENER_ip_src_Filter_block3 IS

  -- Component Declarations
  COMPONENT LTE_GENER_ip_src_FilterCoef_block3
  ...
  COMPONENT LTE_GENER_ip_src_subFilter_block3
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : LTE_GENER_ip_src_FilterCoef_block3
    USE ENTITY work.LTE_GENER_ip_src_FilterCoef_block3(rtl);

  FOR ALL : LTE_GENER_ip_src_subFilter_block3
    USE ENTITY work.LTE_GENER_ip_src_subFilter_block3(rtl);
...
BEGIN
  u_CoefTable_1 : LTE_GENER_ip_src_FilterCoef_block3
  ...
  u_subFilter_1_re : LTE_GENER_ip_src_subFilter_block3
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_subFilter_1_im : LTE_GENER_ip_src_subFilter_block3
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,

-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\zynqRadioHWSWLTEPBCHGeneratorRFSoC2x2\LTE_GENER_ip_src_FilterTapSystolicPreAddWvlIn.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LTE_GENER_ip_src_FilterTapSystolicPreAddWvlIn
...
-- FIR Filter HDL Optimized/Filter/subFilter/FilterTapSystolicPreAddWvlI
-- Hierarchy Level: 7
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY LTE_GENER_ip_src_FilterTapSystolicPreAddWvlIn IS
...
END LTE_GENER_ip_src_FilterTapSystolicPreAddWvlIn;


ARCHITECTURE rtl OF LTE_GENER_ip_src_FilterTapSystolicPreAddWvlIn IS
  ...
  SIGNAL fTap_mult_reg_next               : signed(32 DOWNTO 0);  -- sfix33_En14
  ...
  SIGNAL dinDly2                          : signed(15 DOWNTO 0);  -- sfix16

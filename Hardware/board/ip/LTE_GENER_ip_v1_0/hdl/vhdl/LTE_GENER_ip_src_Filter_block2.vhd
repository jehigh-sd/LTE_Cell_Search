-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\zynqRadioHWSWLTEPBCHGeneratorRFSoC2x2\LTE_GENER_ip_src_Filter_block2.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LTE_GENER_ip_src_Filter_block2
...
-- FIR Filter HDL Optimized3/Filte
-- Hierarchy Level: 5
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY LTE_GENER_ip_src_Filter_block2 IS
...
END LTE_GENER_ip_src_Filter_block2;


ARCHITECTURE rtl OF LTE_GENER_ip_src_Filter_block2 IS

  -- Component Declarations
  COMPONENT LTE_GENER_ip_src_FilterCoef_block2
  ...
  COMPONENT LTE_GENER_ip_src_subFilter_block2
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : LTE_GENER_ip_src_FilterCoef_block2
    USE ENTITY work.LTE_GENER_ip_src_FilterCoef_block2(rtl);

  FOR ALL : LTE_GENER_ip_src_subFilter_block2
    USE ENTITY work.LTE_GENER_ip_src_subFilter_block2(rtl);
...
BEGIN
  u_CoefTable_1 : LTE_GENER_ip_src_FilterCoef_block2
  ...
  u_subFilter_1_re : LTE_GENER_ip_src_subFilter_block2
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_subFilter_1_im : LTE_GENER_ip_src_subFilter_block2
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,

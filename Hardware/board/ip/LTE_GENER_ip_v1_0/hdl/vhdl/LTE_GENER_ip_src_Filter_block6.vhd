-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\zynqRadioHWSWLTEPBCHGeneratorRFSoC2x2\LTE_GENER_ip_src_Filter_block6.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LTE_GENER_ip_src_Filter_block6
...
-- FIR Filter HDL Optimized7/Filte
-- Hierarchy Level: 5
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY LTE_GENER_ip_src_Filter_block6 IS
...
END LTE_GENER_ip_src_Filter_block6;


ARCHITECTURE rtl OF LTE_GENER_ip_src_Filter_block6 IS

  -- Component Declarations
  COMPONENT LTE_GENER_ip_src_FilterCoef_block6
  ...
  COMPONENT LTE_GENER_ip_src_subFilter_block6
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : LTE_GENER_ip_src_FilterCoef_block6
    USE ENTITY work.LTE_GENER_ip_src_FilterCoef_block6(rtl);

  FOR ALL : LTE_GENER_ip_src_subFilter_block6
    USE ENTITY work.LTE_GENER_ip_src_subFilter_block6(rtl);
...
BEGIN
  u_CoefTable_1 : LTE_GENER_ip_src_FilterCoef_block6
  ...
  u_subFilter_1_re : LTE_GENER_ip_src_subFilter_block6
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_subFilter_1_im : LTE_GENER_ip_src_subFilter_block6
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,

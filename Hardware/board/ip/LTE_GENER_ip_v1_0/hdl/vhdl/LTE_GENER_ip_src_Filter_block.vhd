-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\zynqRadioHWSWLTEPBCHGeneratorRFSoC2x2\LTE_GENER_ip_src_Filter_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LTE_GENER_ip_src_Filter_block
...
-- FIR Filter HDL Optimized1/Filte
-- Hierarchy Level: 5
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY LTE_GENER_ip_src_Filter_block IS
...
END LTE_GENER_ip_src_Filter_block;


ARCHITECTURE rtl OF LTE_GENER_ip_src_Filter_block IS

  -- Component Declarations
  COMPONENT LTE_GENER_ip_src_FilterCoef_block
  ...
  COMPONENT LTE_GENER_ip_src_subFilter_block
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : LTE_GENER_ip_src_FilterCoef_block
    USE ENTITY work.LTE_GENER_ip_src_FilterCoef_block(rtl);

  FOR ALL : LTE_GENER_ip_src_subFilter_block
    USE ENTITY work.LTE_GENER_ip_src_subFilter_block(rtl);
...
BEGIN
  u_CoefTable_1 : LTE_GENER_ip_src_FilterCoef_block
  ...
  u_subFilter_1_re : LTE_GENER_ip_src_subFilter_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
  ...
  u_subFilter_1_im : LTE_GENER_ip_src_subFilter_block
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,

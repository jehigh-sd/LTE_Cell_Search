-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\zynqRadioHWSWLTEPBCHGeneratorRFSoC2x2\LTE_GENER_ip_axi4_stream_i_master.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LTE_GENER_ip_axi4_stream_i_master
-- Source Path: LTE_GENER_ip/LTE_GENER_ip_axi4_stream_i_master
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY LTE_GENER_ip_axi4_stream_i_master IS
...
END LTE_GENER_ip_axi4_stream_i_master;


ARCHITECTURE rtl OF LTE_GENER_ip_axi4_stream_i_master IS

  -- Component Declarations
  COMPONENT LTE_GENER_ip_fifo_data_OUT
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT LTE_GENER_ip_fifo_TLAST_OUT
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : LTE_GENER_ip_fifo_data_OUT
    USE ENTITY work.LTE_GENER_ip_fifo_data_OUT(rtl);

  FOR ALL : LTE_GENER_ip_fifo_TLAST_OUT
    USE ENTITY work.LTE_GENER_ip_fifo_TLAST_OUT(rtl);
...
BEGIN
  u_LTE_GENER_ip_fifo_data_OUT_inst : LTE_GENER_ip_fifo_data_OUT
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,
              ...
              Out_rsvd => AXI4_Stream_I_Master_TDATA_tmp,  -- ufix128
              Empty => fifo_empty_data,  -- ufix1
              AFull => fifo_afull_data  -- ufix1
              );

  u_LTE_GENER_ip_fifo_TLAST_OUT_inst : LTE_GENER_ip_fifo_TLAST_OUT
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,

-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\zynqRadioHWSWLTEDecimatorRFSoC2x2\LTE_DOWNS_ip_axi4_stream_i_slave.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LTE_DOWNS_ip_axi4_stream_i_slave
-- Source Path: LTE_DOWNS_ip/LTE_DOWNS_ip_axi4_stream_i_slave
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY LTE_DOWNS_ip_axi4_stream_i_slave IS
...
END LTE_DOWNS_ip_axi4_stream_i_slave;


ARCHITECTURE rtl OF LTE_DOWNS_ip_axi4_stream_i_slave IS

  -- Component Declarations
  COMPONENT LTE_DOWNS_ip_fifo_data
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : LTE_DOWNS_ip_fifo_data
    USE ENTITY work.LTE_DOWNS_ip_fifo_data(rtl);
...
BEGIN
  u_LTE_DOWNS_ip_fifo_data_inst : LTE_DOWNS_ip_fifo_data
    PORT MAP( clk => clk,
              reset_x => reset_x,
              enb => enb,

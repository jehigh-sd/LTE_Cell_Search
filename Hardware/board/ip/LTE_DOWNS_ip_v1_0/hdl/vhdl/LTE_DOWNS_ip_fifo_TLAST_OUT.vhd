-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\zynqRadioHWSWLTEDecimatorRFSoC2x2\LTE_DOWNS_ip_fifo_TLAST_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LTE_DOWNS_ip_fifo_TLAST_OUT
-- Source Path: LTE_DOWNS_ip/LTE_DOWNS_ip_axi4_stream_i_master/LTE_DOWNS_ip_fifo_TLAST_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY LTE_DOWNS_ip_fifo_TLAST_OUT IS
...
END LTE_DOWNS_ip_fifo_TLAST_OUT;


ARCHITECTURE rtl OF LTE_DOWNS_ip_fifo_TLAST_OUT IS
...
BEGIN
  ...
  u_LTE_DOWNS_ip_fifo_TLAST_OUT_classic_ram_singlebit : LTE_DOWNS_ip_SimpleDualPortRAM_singlebit

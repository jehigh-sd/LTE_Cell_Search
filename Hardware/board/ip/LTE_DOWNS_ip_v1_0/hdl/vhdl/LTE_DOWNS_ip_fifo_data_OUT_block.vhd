-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\zynqRadioHWSWLTEDecimatorRFSoC2x2\LTE_DOWNS_ip_fifo_data_OUT_block.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: LTE_DOWNS_ip_fifo_data_OUT_block
-- Source Path: LTE_DOWNS_ip/LTE_DOWNS_ip_axi4_stream_q_master/LTE_DOWNS_ip_fifo_data_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY LTE_DOWNS_ip_fifo_data_OUT_block IS
...
END LTE_DOWNS_ip_fifo_data_OUT_block;


ARCHITECTURE rtl OF LTE_DOWNS_ip_fifo_data_OUT_block IS

  -- Component Declarations
  COMPONENT LTE_DOWNS_ip_SimpleDualPortRAM_generic
  ...
  FOR ALL : LTE_DOWNS_ip_SimpleDualPortRAM_generic
    USE ENTITY work.LTE_DOWNS_ip_SimpleDualPortRAM_generic(rtl);
...
BEGIN
  ...
  u_LTE_DOWNS_ip_fifo_data_OUT_classic_ram : LTE_DOWNS_ip_SimpleDualPortRAM_generic
